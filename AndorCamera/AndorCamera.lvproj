...
<Project Type="Project" LVVersion="20008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Reentrant Multiple Progress" Type="Folder">
			<Item Name="SubVIs" Type="Folder">
				<Item Name="updateRef.vi" Type="VI" URL="../../../shared programs/GUI_Template/Reentrant Multiple Progress/SubVIs/updateRef.vi"/>
			</Item>
			...
			<Item Name="general tcp data gatherer.vi" Type="VI" URL="../../../shared programs/GUI_Template/Reentrant Multiple Progress/general tcp data gatherer.vi"/>
			<Item Name="Main.vi" Type="VI" URL="../../../shared programs/GUI_Template/Reentrant Multiple Progress/Main.vi"/>
			<Item Name="message process vis.vi" Type="VI" URL="../../../shared programs/GUI_Template/Reentrant Multiple Progress/message process vis.vi"/>
			<Item Name="Multiple Reentrant Dialogs.aliases" Type="Document" URL="../../../shared programs/GUI_Template/Reentrant Multiple Progress/Multiple Reentrant Dialogs.aliases"/>
			<Item Name="Multiple Reentrant Dialogs.lvlps" Type="Document" URL="../../../shared programs/GUI_Template/Reentrant Multiple Progress/Multiple Reentrant Dialogs.lvlps"/>
			<Item Name="Multiple Reentrant Dialogs.lvproj" Type="Document" URL="../../../shared programs/GUI_Template/Reentrant Multiple Progress/Multiple Reentrant Dialogs.lvproj"/>
			<Item Name="Reentrant master GUI data updater no events.vi" Type="VI" URL="../../../shared programs/GUI_Template/Reentrant Multiple Progress/Reentrant master GUI data updater no events.vi"/>
			<Item Name="Reentrant master GUI data updater.vi" Type="VI" URL="../../../shared programs/GUI_Template/Reentrant Multiple Progress/Reentrant master GUI data updater.vi"/>
			<Item Name="Reentrant Process.vi" Type="VI" URL="../../../shared programs/GUI_Template/Reentrant Multiple Progress/Reentrant Process.vi"/>
			<Item Name="reentrant TCP data FGV.vi" Type="VI" URL="../../../shared programs/GUI_Template/Reentrant Multiple Progress/reentrant TCP data FGV.vi"/>
			<Item Name="Reentrant tcp for data gatherer.vi" Type="VI" URL="../../../shared programs/GUI_Template/Reentrant Multiple Progress/Reentrant tcp for data gatherer.vi"/>
			<Item Name="reentrant TCP stop FGV.vi" Type="VI" URL="../../../shared programs/GUI_Template/Reentrant Multiple Progress/reentrant TCP stop FGV.vi"/>
			<Item Name="renetrant data update subvi.vi" Type="VI" URL="../../../shared programs/GUI_Template/Reentrant Multiple Progress/renetrant data update subvi.vi"/>
			<Item Name="replies to tcp data array.vi" Type="VI" URL="../../../shared programs/GUI_Template/Reentrant Multiple Progress/replies to tcp data array.vi"/>
		</Item>
		...
		<Item Name="AndorCamera.lvclass" Type="LVClass" URL="../AndorCamera.lvclass"/>
		<Item Name="get image data.vi" Type="VI" URL="../get image data.vi"/>
		<Item Name="test.vi" Type="VI" URL="../Subvis/test.vi"/>
		<Item Name="sample init.vi" Type="VI" URL="../Subvis/sample init.vi"/>
		<Item Name="1DArraytoImage.vi" Type="VI" URL="../Subvis/1DArraytoImage.vi"/>
		<Item Name="Point Grey Camera.lvclass" Type="LVClass" URL="../../Point Grey Camera/Point Grey Camera.lvclass"/>
		<Item Name="ForceShutdown.vi" Type="VI" URL="../Subvis/ForceShutdown.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Error Code Enum typedef.ctl" Type="VI" URL="../Error Code Enum typedef.ctl"/>
			<Item Name="Error Code Offset global.vi" Type="VI" URL="../Error Code Offset global.vi"/>
			<Item Name="Add ECO For DLL.vi" Type="VI" URL="../Add ECO For DLL.vi"/>
			<Item Name="Subtract ECO For DLL.vi" Type="VI" URL="../Subtract ECO For DLL.vi"/>
			<Item Name="Add ECO For LabVIEW.vi" Type="VI" URL="../Add ECO For LabVIEW.vi"/>
			<Item Name="Join Strings.vi" Type="VI" URL="../Join Strings.vi"/>
			<Item Name="Get Error Source.vi" Type="VI" URL="../Get Error Source.vi"/>
			<Item Name="Error Code Handler.vi" Type="VI" URL="../Error Code Handler.vi"/>
			<Item Name="HSSpeed_type typedef.ctl" Type="VI" URL="../HSSpeed_type typedef.ctl"/>
			<Item Name="SetHSSpeed.vi" Type="VI" URL="../Subvis/SetHSSpeed.vi"/>
			<Item Name="GetDetector.vi" Type="VI" URL="../GetDetector.vi"/>
			<Item Name="ReadMode_mode typedef.ctl" Type="VI" URL="../ReadMode_mode typedef.ctl"/>
			<Item Name="SetReadMode.vi" Type="VI" URL="../Subvis/SetReadMode.vi"/>
			<Item Name="AcquisitionMode_mode typedef.ctl" Type="VI" URL="../AcquisitionMode_mode typedef.ctl"/>
			<Item Name="SetAcquisitionMode.vi" Type="VI" URL="../SetAcquisitionMode.vi"/>
			<Item Name="Initialize.vi" Type="VI" URL="../Subvis/Initialize.vi"/>
			<Item Name="GetNumberVSSpeeds.vi" Type="VI" URL="../Subvis/GetNumberVSSpeeds.vi"/>
			<Item Name="SetVSSpeed.vi" Type="VI" URL="../SetVSSpeed.vi"/>
			<Item Name="U32 To Error Code Enum.vi" Type="VI" URL="../Subvis/U32 To Error Code Enum.vi"/>
			<Item Name="GetTemperature.vi" Type="VI" URL="../GetTemperature.vi"/>
			<Item Name="StartAcquisition.vi" Type="VI" URL="../Subvis/StartAcquisition.vi"/>
			<Item Name="GetStatus.vi" Type="VI" URL="../Subvis/GetStatus.vi"/>
			<Item Name="SetExposureTime.vi" Type="VI" URL="../Subvis/SetExposureTime.vi"/>
			<Item Name="GetAcquisitionTimings.vi" Type="VI" URL="../GetAcquisitionTimings.vi"/>
			<Item Name="SetTemperature.vi" Type="VI" URL="../SetTemperature.vi"/>
			<Item Name="CoolerON.vi" Type="VI" URL="../CoolerON.vi"/>
			<Item Name="SetDDGIntelligate.vi" Type="VI" URL="../SetDDGIntelligate.vi"/>
			<Item Name="SetDDGInsertionDelay.vi" Type="VI" URL="../Subvis/SetDDGInsertionDelay.vi"/>
			<Item Name="SetDDGIOC.vi" Type="VI" URL="../Subvis/SetDDGIOC.vi"/>
			<Item Name="SetDDGGateStep.vi" Type="VI" URL="../SetDDGGateStep.vi"/>
			<Item Name="GetAcquiredData.vi" Type="VI" URL="../GetAcquiredData.vi"/>
			...
			<Item Name="ROI_TypDef.ctl" Type="VI" URL="../../Point Grey Camera/subVis/ROI_TypDef.ctl"/>
			...
			<Item Name="Comparison.ctl" Type="VI" URL="../../Point Grey Camera/subVis/Comparison.ctl"/>
			<Item Name="Compare numbers.vi" Type="VI" URL="../../Point Grey Camera/subVis/Compare numbers.vi"/>
			<Item Name="Set Attribute.vi" Type="VI" URL="../../Point Grey Camera/subVis/Set Attribute.vi"/>
			...
			<Item Name="CoolerOFF.vi" Type="VI" URL="../Subvis/CoolerOFF.vi"/>
			<Item Name="ShutDown.vi" Type="VI" URL="../Subvis/ShutDown.vi"/>
			<Item Name="TriggerMode_mode typedef.ctl" Type="VI" URL="../Subvis/TriggerMode_mode typedef.ctl"/>
			<Item Name="SetTriggerMode.vi" Type="VI" URL="../Subvis/SetTriggerMode.vi"/>
			<Item Name="SetImage.vi" Type="VI" URL="../Subvis/SetImage.vi"/>
			<Item Name="WaitForAcquisitionTimeout.vi" Type="VI" URL="../Subvis/WaitForAcquisitionTimeout.vi"/>
			<Item Name="AbortAcquisition.vi" Type="VI" URL="../Subvis/AbortAcquisition.vi"/>
			<Item Name="SetMCPGain.vi" Type="VI" URL="../Subvis/SetMCPGain.vi"/>
			<Item Name="GetNumberAmp.vi" Type="VI" URL="../Subvis/GetNumberAmp.vi"/>
			<Item Name="GetNumberHSSpeeds.vi" Type="VI" URL="../Subvis/GetNumberHSSpeeds.vi"/>
			<Item Name="GetHSSpeed.vi" Type="VI" URL="../Subvis/GetHSSpeed.vi"/>
			<Item Name="SetNumberAccumulations.vi" Type="VI" URL="../Subvis/SetNumberAccumulations.vi"/>
			<Item Name="SetAccumulationCycleTime.vi" Type="VI" URL="../Subvis/SetAccumulationCycleTime.vi"/>
			<Item Name="GateMode_mode typedef.ctl" Type="VI" URL="../Subvis/GateMode_mode typedef.ctl"/>
			<Item Name="SetGateMode.vi" Type="VI" URL="../Subvis/SetGateMode.vi"/>
			<Item Name="SetDDGGateTime.vi" Type="VI" URL="../Subvis/SetDDGGateTime.vi"/>
			<Item Name="SetNumberKinetics.vi" Type="VI" URL="../Subvis/SetNumberKinetics.vi"/>
			<Item Name="SetKineticCycleTime.vi" Type="VI" URL="../Subvis/SetKineticCycleTime.vi"/>
			<Item Name="SetDDGIOCFrequency.vi" Type="VI" URL="../Subvis/SetDDGIOCFrequency.vi"/>
			<Item Name="SetImageFlip.vi" Type="VI" URL="../Subvis/SetImageFlip.vi"/>
			...
			<Item Name="Abort if acquiring.vi" Type="VI" URL="../Abort if acquiring.vi"/>
			<Item Name="Start Acquisition if Idle.vi" Type="VI" URL="../Start Acquisition if Idle.vi"/>
			...
			<Item Name="atmcd32d.dll" Type="Document" URL="../../../../../../Program Files/Andor Driver Pack 2/atmcd32d.dll"/>
			...
			<Item Name="ATMCD32D.dll" Type="Document" URL="/../Program Files/Andor SOLIS/Drivers/Examples/LabVIEW/System Files/ATMCD32D.dll"/>
			<Item Name="Coerce I64.vi" Type="VI" URL="../../Point Grey Camera/Set IMAQdx Camera ROI/Coerce I64.vi"/>
			<Item Name="Rounding Mode.ctl" Type="VI" URL="../../Point Grey Camera/Set IMAQdx Camera ROI/Rounding Mode.ctl"/>
			<Item Name="coerce exposure to available increment.vi" Type="VI" URL="../../Point Grey Camera/subVis/coerce exposure to available increment.vi"/>
			<Item Name="ATMCD32D.dll" Type="Document" URL="../Subvis/Andor LabVIEW SDK/System Files/ATMCD32D.dll"/>
		</Item>
		<Item Name="Build Specifications" Type="Build">
			<Item Name="AndorCamera" Type="Source Distribution">
				<Property Name="Bld_autoIncrement" Type="Bool">true</Property>
				<Property Name="Bld_buildCacheID" Type="Str">{F5325AAA-B8B3-4984-AB4D-B759165745E5}</Property>
				<Property Name="Bld_buildSpecName" Type="Str">AndorCamera</Property>
				...
				<Property Name="Bld_previewCacheID" Type="Str">{7E2D77CE-C078-4C8E-8295-729DF8B7EA34}</Property>
				...
				<Property Name="Source[0].itemID" Type="Str">{37142AD9-7544-4202-93D8-48B3B41919C8}</Property>
				<Property Name="Source[0].type" Type="Str">Container</Property>
				<Property Name="Source[1].destinationIndex" Type="Int">0</Property>
				<Property Name="Source[1].itemID" Type="Ref">/My Computer/AndorCamera.lvclass</Property>
