...
extern "C"
{
	...
	FILTERWHEELDLL_API void __cdecl FW_Identify(char const * serialNo);
	...
	/// <seealso cref="FW_EnableLastMsgTimer(char const * serialNo, bool enable, __int32 lastMsgTimeout )" />
	/// <seealso cref="FW_HasLastMsgTimerOverrun(char const * serialNo)" />
	/// \include CodeSnippet_connectionMonitoring.cpp
	FILTERWHEELDLL_API bool __cdecl FW_TimeSinceLastMsgReceived(char const * serialNo, __int64 &lastUpdateTimeMS );
	...
	/// <seealso cref="FW_TimeSinceLastMsgReceived(char const * serialNo, __int64 &lastUpdateTimeMS )" />
	/// <seealso cref="FW_HasLastMsgTimerOverrun(char const * serialNo)" />
	/// \include CodeSnippet_connectionMonitoring.cpp
	FILTERWHEELDLL_API void __cdecl FW_EnableLastMsgTimer(char const * serialNo, bool enable, __int32 lastMsgTimeout );

	/// <summary> Queries if the time since the last message has exceeded the lastMsgTimeout set by <see cref="FW_EnableLastMsgTimer(char const * serialNo, bool enable, __int32 lastMsgTimeout )"/>. </summary>
	/// <remarks> This can be used to determine whether communications with the device is still good</remarks>
	/// <param name="serialNo"> The device serial no. </param>
	...
	/// <seealso cref="FW_EnableLastMsgTimer(char const * serialNo, bool enable, __int32 lastMsgTimeout )" />
	/// \include CodeSnippet_connectionMonitoring.cpp
	FILTERWHEELDLL_API bool __cdecl FW_HasLastMsgTimerOverrun(char const * serialNo);}
/** @} */ // FilterWheel
