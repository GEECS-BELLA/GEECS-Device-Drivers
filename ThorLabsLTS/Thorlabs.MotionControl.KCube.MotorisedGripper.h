...
/** @defgroup KCubeMotorisedGripper KCube DCServo
 ...
 */
	...
	/// <param name="serialNo"> The device serial no. </param>
	/// <returns> <c>true</c> if successful, false if not. </returns>
	KCUBEMOTORISEDGRIPPER_API short __cdecl CC_ResetStageToDefaults(char const * serialNo);
	...
	KCUBEMOTORISEDGRIPPER_API bool __cdecl CC_CanMoveWithoutHomingFirst(char const * serialNo);
	...
	KCUBEMOTORISEDGRIPPER_API  short __cdecl CC_GetMMIParams(char const * serialNo, KMOT_JoyStickMode *joystickMode, __int32 *joystickMaxVelocity, __int32 *joystickAcceleration, KMOT_JoystickDirectionSense *directionSense,
	...
	/// <seealso cref="CC_SetMMIParamsBlock(const char * serialNo, KMOT_MMIParams *mmiParams)" />
	/// <seealso cref="CC_GetMMIParamsBlock(const char * serialNo, KMOT_MMIParams *mmiParams)" />
	KCUBEMOTORISEDGRIPPER_API short __cdecl CC_SetMMIParams(char const * serialNo, KMOT_JoyStickMode joystickMode, __int32 joystickMaxVelocity, __int32 joystickAcceleration, KMOT_JoystickDirectionSense directionSense,
								   __int32 presetPosition1, __int32 presetPosition2, __int16 displayIntensity);
	...
	KCUBEMOTORISEDGRIPPER_API  short __cdecl CC_GetTriggerConfigParams(char const * serialNo, KMOT_TriggerPortMode *trigger1Mode, KMOT_TriggerPortPolarity *trigger1Polarity, KMOT_TriggerPortMode *trigger2Mode, KMOT_TriggerPortPolarity *trigger2Polarity);
	...
	/// <seealso cref="CC_SetTriggerConfigParamsBlock(const char * serialNo, KMOT_TriggerConfig *triggerConfigParams)" />
	/// <seealso cref="CC_GetTriggerConfigParamsBlock(const char * serialNo, KMOT_TriggerConfig *triggerConfigParams)" />
	KCUBEMOTORISEDGRIPPER_API short __cdecl CC_SetTriggerConfigParams(char const * serialNo, KMOT_TriggerPortMode trigger1Mode, KMOT_TriggerPortPolarity trigger1Polarity, KMOT_TriggerPortMode trigger2Mode, KMOT_TriggerPortPolarity trigger2Polarity);
	...
	KCUBEMOTORISEDGRIPPER_API  short __cdecl CC_GetTriggerParamsParams(char const * serialNo, __int32 *triggerStartPositionFwd, __int32 *triggerIntervalFwd, __int32 *triggerPulseCountFwd, 
										 __int32 *triggerStartPositionRev, __int32 *triggerIntervalRev, __int32 *triggerPulseCountRev, 
										 __int32 *triggerPulseWidth, __int32 *cycleCount);
	...
	/// <seealso cref="CC_GetTriggerParamsParamsBlock(const char * serialNo, KMOT_TriggerParams *triggerParamsParams)" />
	/// <seealso cref="CC_SetTriggerParamsParamsBlock(const char * serialNo, KMOT_TriggerParams *triggerParamsParams)" />
	KCUBEMOTORISEDGRIPPER_API short __cdecl CC_SetTriggerParamsParams(char const * serialNo, __int32 triggerStartPositionFwd, __int32 triggerIntervalFwd, __int32 triggerPulseCountFwd,
										__int32 triggerStartPositionRev, __int32 triggerIntervalRev, __int32 triggerPulseCountRev,
										__int32 triggerPulseWidth, __int32 cycleCount);
	...
	/// <seealso cref="CC_SetMMIParams(char const * serialNo, KMOT_JoyStickMode joystickMode, __int32 joystickMaxVelocity, __int32 joystickAcceleration, KMOT_JoystickDirectionSense directionSense, __int32 presetPosition1, __int32 presetPosition2, __int16 displayIntensity)" />
	/// <seealso cref="CC_SetMMIParamsBlock(const char * serialNo, KMOT_MMIParams *mmiParams)" />
	KCUBEMOTORISEDGRIPPER_API short __cdecl CC_GetMMIParamsBlock(char const * serialNo, KMOT_MMIParams *mmiParams);
	...
	/// <seealso cref="CC_SetMMIParams(char const * serialNo, KMOT_JoyStickMode joystickMode, __int32 joystickMaxVelocity, __int32 joystickAcceleration, KMOT_JoystickDirectionSense directionSense, __int32 presetPosition1, __int32 presetPosition2, __int16 displayIntensity)" />
	/// <seealso cref="CC_GetMMIParamsBlock(const char * serialNo, KMOT_MMIParams *mmiParams)" />
	KCUBEMOTORISEDGRIPPER_API short __cdecl CC_SetMMIParamsBlock(char const * serialNo, KMOT_MMIParams *mmiParams);
	...
	/// <seealso cref="CC_SetTriggerConfigParams(char const * serialNo, KMOT_TriggerPortMode trigger1Mode, KMOT_TriggerPortPolarity trigger1Polarity, KMOT_TriggerPortMode trigger2Mode, KMOT_TriggerPortPolarity trigger2Polarity)" />
	/// <seealso cref="CC_SetTriggerConfigParamsBlock(const char * serialNo, KMOT_TriggerConfig *triggerConfigParams)" />
	KCUBEMOTORISEDGRIPPER_API short __cdecl CC_GetTriggerConfigParamsBlock(char const * serialNo, KMOT_TriggerConfig *triggerConfigParams);
	...
	/// <seealso cref="CC_SetTriggerConfigParams(char const * serialNo, KMOT_TriggerPortMode trigger1Mode, KMOT_TriggerPortPolarity trigger1Polarity, KMOT_TriggerPortMode trigger2Mode, KMOT_TriggerPortPolarity trigger2Polarity)" />
	/// <seealso cref="CC_GetTriggerConfigParamsBlock(const char * serialNo, KMOT_TriggerConfig *triggerConfigParams)" />
	KCUBEMOTORISEDGRIPPER_API short __cdecl CC_SetTriggerConfigParamsBlock(char const * serialNo, KMOT_TriggerConfig *triggerConfigParams);
	...
	///										__int32 triggerPulseWidth, __int32 cycleCount)" />
	/// <seealso cref="CC_SetTriggerParamsParamsBlock(const char * serialNo, KMOT_TriggerParams *triggerParamsParams)" />
	KCUBEMOTORISEDGRIPPER_API short __cdecl CC_GetTriggerParamsParamsBlock(char const * serialNo, KMOT_TriggerParams *triggerParamsParams);
	...
	///										__int32 triggerPulseWidth, __int32 cycleCount)" />
	/// <seealso cref="CC_GetTriggerParamsParamsBlock(const char * serialNo, KMOT_TriggerParams *triggerParamsParams)" />
	KCUBEMOTORISEDGRIPPER_API short __cdecl CC_SetTriggerParamsParamsBlock(char const * serialNo, KMOT_TriggerParams *triggerParamsParams);
	...
	KCUBEMOTORISEDGRIPPER_API bool __cdecl CC_TimeSinceLastMsgReceived(char const * serialNo, __int64 &lastUpdateTimeMS );
	...
	/// <seealso cref="CC_HasLastMsgTimerOverrun(char const * serialNo)" />
	/// \include CodeSnippet_connectionMonitoring.cpp
	KCUBEMOTORISEDGRIPPER_API void __cdecl CC_EnableLastMsgTimer(char const * serialNo, bool enable, __int32 lastMsgTimeout );
	...
	/// <seealso cref="CC_EnableLastMsgTimer(char const * serialNo, bool enable, __int32 lastMsgTimeout )" />
	/// \include CodeSnippet_connectionMonitoring.cpp
	KCUBEMOTORISEDGRIPPER_API bool __cdecl CC_HasLastMsgTimerOverrun(char const * serialNo);
	...
	KCUBEMOTORISEDGRIPPER_API short __cdecl CC_SetMotorVelocityLimits(char const * serialNo, double maxVelocity, double maxAcceleration);
	...
	KCUBEMOTORISEDGRIPPER_API short __cdecl CC_GetMotorVelocityLimits(char const * serialNo, double *maxVelocity, double *maxAcceleration);
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="CC_GetMotorTravelLimits(char const * serialNo, double *minPosition, double *maxPosition)" />
	KCUBEMOTORISEDGRIPPER_API short __cdecl CC_SetMotorTravelLimits(char const * serialNo, double minPosition, double maxPosition);
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="CC_SetMotorTravelLimits(char const * serialNo, double minPosition, double maxPosition)" />
	KCUBEMOTORISEDGRIPPER_API short __cdecl CC_GetMotorTravelLimits(char const * serialNo, double *minPosition, double *maxPosition);
	...
	KCUBEMOTORISEDGRIPPER_API short __cdecl CC_GetRealValueFromDeviceUnit(char const * serialNo, int device_unit, double *real_unit, int unitType);
	...
	KCUBEMOTORISEDGRIPPER_API short __cdecl CC_GetDeviceUnitFromRealValue(char const * serialNo, double real_unit, int *device_unit, int unitType);
	...
	KCUBEMOTORISEDGRIPPER_API short __cdecl CC_RequestDigitalOutputs(char const * serialNo);
	...
	KCUBEMOTORISEDGRIPPER_API byte __cdecl CC_GetDigitalOutputs(char const * serialNo);
	...
	/// <seealso cref="CC_GetDigitalOutputs(char const * serialNo)" />
	/// <seealso cref="CC_RequestDigitalOutputs(char const * serialNo)" />
	KCUBEMOTORISEDGRIPPER_API short __cdecl CC_SetDigitalOutputs(char const * serialNo, byte outputsBits);
