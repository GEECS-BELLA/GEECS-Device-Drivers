...
#pragma pack()
	...
	/// <seealso cref="TLI_GetDeviceListByTypeExt(char *receiveBuffer, DWORD sizeOfBuffer, int typeID)" />
	/// <seealso cref="TLI_GetDeviceListByTypesExt(char *receiveBuffer, DWORD sizeOfBuffer, int * typeIDs, int length)" />
	BENCHTOPDCSERVO_API short _cdecl TLI_GetDeviceInfo(char const * serialNo, TLI_DeviceInfo *info);

	/// <summary> Open the device for communications. </summary>
	/// <param name="serialNo">	The serial no of the controller to be connected. </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
    /// 		  \include CodeSnippet_connectionN.cpp
	/// <seealso cref="DBC_Close(char const * serialNo)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_Open(char const * serialNo);
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
    /// 		  \include CodeSnippet_connectionN.cpp
	/// <seealso cref="DBC_Open(char const * serialNo)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_Close(char const * serialNo);
    ...
    /// 		  \include CodeSnippet_connectionN.cpp
	BENCHTOPDCSERVO_API bool __cdecl DBC_IsChannelValid(char const * serialNo, short channel);
    ...
    /// 		  \include CodeSnippet_connectionN.cpp
	BENCHTOPDCSERVO_API int __cdecl DBC_MaxChannelCount(char const * serialNo);

	/// <summary> Sends a command to the device to make it identify iteself. </summary>
	/// <param name="serialNo">	The controller serial no. </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	BENCHTOPDCSERVO_API short __cdecl DBC_Identify(char const * serialNo);
	...
	BENCHTOPDCSERVO_API short __cdecl DBC_GetHardwareInfo(char const * serialNo, short channel, char * modelNo, DWORD sizeOfModelNo, WORD * type, WORD * numChannels, 
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
    /// 		  \include CodeSnippet_identify.cpp
	BENCHTOPDCSERVO_API short __cdecl DBC_GetHardwareInfoBlock(char const * serialNo, short channel, TLI_HardwareInformation *hardwareInfo);

	/// <summary> Gets the number of channels in the device. </summary>
	/// <param name="serialNo">	The controller serial no. </param>
	/// <returns> The number of channels. </returns>
	BENCHTOPDCSERVO_API short __cdecl DBC_GetNumChannels(char const * serialNo);
    ...
    /// 		  \include CodeSnippet_identify.cpp
	BENCHTOPDCSERVO_API DWORD __cdecl DBC_GetFirmwareVersion(char const * serialNo, short channel);
    ...
    /// 		  \include CodeSnippet_identify.cpp
	BENCHTOPDCSERVO_API DWORD __cdecl DBC_GetSoftwareVersion(char const * serialNo);
    ...
    /// 		  \include CodeSnippet_connectionN.cpp
	BENCHTOPDCSERVO_API bool __cdecl DBC_LoadSettings(char const * serialNo, short channel);
	...
	/// <seealso cref="DBC_IsCalibrationActive(char const * serialNo, short channel)" />
	/// <seealso cref="DBC_GetCalibrationFile(char const * serialNo, short channel, char * filename, short sizeOfBuffer)" />
	BENCHTOPDCSERVO_API void __cdecl DBC_SetCalibrationFile(char const * serialNo, short channel, char const *filename, bool enabled);
	...
	/// <seealso cref="DBC_GetCalibrationFile(char const * serialNo, short channel, char * filename, short sizeOfBuffer)" />
	/// <seealso cref="DBC_SetCalibrationFile(char const * serialNo, short channel, char const *filename, bool enabled)" />
	BENCHTOPDCSERVO_API bool __cdecl DBC_IsCalibrationActive(char const * serialNo, short channel);
	...
	/// <seealso cref="DBC_IsCalibrationActive(char const * serialNo, short channel)" />
	/// <seealso cref="DBC_SetCalibrationFile(char const * serialNo, short channel, char const *filename, bool enabled)" />
	BENCHTOPDCSERVO_API bool __cdecl DBC_GetCalibrationFile(char const * serialNo, short channel, char * filename, short sizeOfBuffer);
	...
	/// <param name="channel">  The channel (1 to n). </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="DBC_EnableChannel(char const * serialNo, short channel)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_DisableChannel(char const * serialNo, short channel);
	...
	/// <param name="channel">  The channel (1 to n). </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="DBC_DisableChannel(char const * serialNo, short channel)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_EnableChannel(char const * serialNo, short channel);
	...
	/// <seealso cref="DBC_MoveToPosition(char const * serialNo, short channel, int index)" />
	/// <seealso cref="DBC_GetPosition(char const * serialNo, short channel)" />
	/// <seealso cref="DBC_Home(char const * serialNo, short channel)" />
    /// 		  \include CodeSnippet_move.cpp
	BENCHTOPDCSERVO_API int __cdecl DBC_GetNumberPositions(char const * serialNo, short channel);
	...
	/// <seealso cref="DBC_GetNumberPositions(char const * serialNo, short channel)" />
	/// <seealso cref="DBC_SetVelParams(char const * serialNo, short channel, int acceleration, int maxVelocity)" />
	/// <seealso cref="DBC_GetPosition(char const * serialNo, short channel)" />
	/// <seealso cref="DBC_GetVelParams(char const * serialNo, short channel, int * acceleration, int * maxVelocity)" />
	/// <seealso cref="DBC_GetVelParamsBlock(char const * serialNo, short channel, MOT_VelocityParameters  *velocityParams)" />
	/// <seealso cref="DBC_SetVelParamsBlock(char const * serialNo, short channel, MOT_VelocityParameters *velocityParams)" />
	/// <seealso cref="DBC_MoveRelative(char const * serialNo, short channel, int displacement)" />
	/// <seealso cref="DBC_MoveAtVelocity(char const * serialNo, short channel, MOT_TravelDirection direction)" />
    /// 		  \include CodeSnippet_move.cpp
	BENCHTOPDCSERVO_API short __cdecl DBC_MoveToPosition(char const * serialNo, short channel, int index);
	...
	/// <seealso cref="DBC_Home(char const * serialNo, short channel)" />
    /// 		  \include CodeSnippet_move.cpp
	BENCHTOPDCSERVO_API int __cdecl DBC_GetPosition(char const * serialNo, short channel);

	/// <summary> Can the device perform a Home. </summary>
	/// <param name="serialNo"> The controller serial no. </param>
	/// <param name="channel">  The channel (1 to n). </param>
	/// <returns> <c>true</c> if the device can home. </returns>
	BENCHTOPDCSERVO_API bool __cdecl DBC_CanHome(char const * serialNo, short channel);

	/// <summary> Does the device need to be Homed before a move can be performed. </summary>
	/// <remarks> @deprecated superceded by <see cref="DBC_CanMoveWithoutHomingFirst(char const * serialNo, short channel)"/> </remarks>
	/// <param name="serialNo"> The controller serial no. </param>
	/// <param name="channel">  The channel (1 to n). </param>
	/// <returns> <c>true</c> if the device needs homing. </returns>
	BENCHTOPDCSERVO_API bool __cdecl DBC_NeedsHoming(char const * serialNo, short channel);
	...
	BENCHTOPDCSERVO_API bool __cdecl DBC_CanMoveWithoutHomingFirst(char const * serialNo, short channel);
	...
	/// <seealso cref="DBC_GetPosition(char const * serialNo, short channel)" />
    /// 		  \include CodeSnippet_move.cpp
	BENCHTOPDCSERVO_API short __cdecl DBC_Home(char const * serialNo, short channel);
	...
	/// <param name="channel">  The channel (1 to n). </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	BENCHTOPDCSERVO_API short __cdecl DBC_ClearMessageQueue(char const * serialNo, short channel);
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	BENCHTOPDCSERVO_API short __cdecl DBC_RegisterMessageCallback(char const * serialNo, short channel, void (* functionPointer)());
	...
	BENCHTOPDCSERVO_API int __cdecl DBC_MessageQueueSize(char const * serialNo, short channel);
	...
	/// <returns> <c>true</c> if successful, false if not. </returns>
	BENCHTOPDCSERVO_API bool __cdecl DBC_GetNextMessage(char const * serialNo, short channel, WORD * messageType, WORD * messageID, DWORD *messageData);
	...
	/// <param name="messageData"> Address of the DWORD to receive the messageData. </param>
	/// <returns> <c>true</c> if successful, false if not. </returns>
	BENCHTOPDCSERVO_API bool __cdecl DBC_WaitForMessage(char const * serialNo, short channel, WORD * messageType, WORD * messageID, DWORD *messageData);
	...
	/// <seealso cref="DBC_SetHomingVelocity(char const * serialNo, short channel, unsigned int velocity)" />
	/// <seealso cref="DBC_GetHomingParamsBlock(char const * serialNo, short channel, MOT_HomingParameters *homingParams)" />
	/// <seealso cref="DBC_SetHomingParamsBlock(char const * serialNo, short channel, MOT_HomingParameters *homingParams)" />
	BENCHTOPDCSERVO_API unsigned int __cdecl DBC_GetHomingVelocity(char const * serialNo, short channel);
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="DBC_GetHomingVelocity(char const * serialNo, short channel)" />
	/// <seealso cref="DBC_GetHomingParamsBlock(char const * serialNo, short channel, MOT_HomingParameters *homingParams)" />
	/// <seealso cref="DBC_SetHomingParamsBlock(char const * serialNo, short channel, MOT_HomingParameters *homingParams)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_SetHomingVelocity(char const * serialNo, short channel, unsigned int velocity);
	...
	/// <seealso cref="DBC_MoveAtVelocity(char const * serialNo, short channel, MOT_TravelDirection direction)" />
    /// 		  \include CodeSnippet_move.cpp
	BENCHTOPDCSERVO_API short __cdecl DBC_MoveRelative(char const * serialNo, short channel, int displacement);
	...
	/// 					 </list> </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="DBC_SetJogMode(char const * serialNo, short channel, MOT_JogModes mode, MOT_StopModes stopMode)" />
	/// <seealso cref="DBC_GetJogStepSize(char const * serialNo, short channel)" />
	/// <seealso cref="DBC_SetJogStepSize(char const * serialNo, short channel, unsigned int stepSize)" />
	/// <seealso cref="DBC_SetJogVelParams(char const * serialNo, short channel, int acceleration, int maxVelocity)" />
	/// <seealso cref="DBC_GetJogVelParams(char const * serialNo, short channel, int * acceleration, int * maxVelocity)" />
	/// <seealso cref="DBC_GetJogParamsBlock(char const * serialNo, short channel, MOT_JogParameters *jogParams)" />
	/// <seealso cref="DBC_SetJogParamsBlock(char const * serialNo, short channel, MOT_JogParameters *jogParams)" />
	/// <seealso cref="DBC_MoveJog(char const * serialNo, short channel, MOT_TravelDirection jogDirection)" />
    /// 		  \include CodeSnippet_jogpars.cpp
	BENCHTOPDCSERVO_API short __cdecl DBC_GetJogMode(char const * serialNo, short channel, MOT_JogModes * mode, MOT_StopModes * stopMode);
	...
	/// 					 </list>  </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="DBC_GetJogMode(char const * serialNo, short channel, MOT_JogModes * mode, MOT_StopModes * stopMode)" />
	/// <seealso cref="DBC_GetJogStepSize(char const * serialNo, short channel)" />
	/// <seealso cref="DBC_SetJogStepSize(char const * serialNo, short channel, unsigned int stepSize)" />
	/// <seealso cref="DBC_SetJogVelParams(char const * serialNo, short channel, int acceleration, int maxVelocity)" />
	/// <seealso cref="DBC_GetJogVelParams(char const * serialNo, short channel, int * acceleration, int * maxVelocity)" />
	...
	/// <seealso cref="DBC_MoveJog(char const * serialNo, short channel, MOT_TravelDirection jogDirection)" />
    /// 		  \include CodeSnippet_jogpars.cpp
	BENCHTOPDCSERVO_API short __cdecl DBC_SetJogMode(char const * serialNo, short channel, MOT_JogModes mode, MOT_StopModes stopMode);
	...
	/// <seealso cref="DBC_MoveJog(char const * serialNo, short channel, MOT_TravelDirection jogDirection)" />
    /// 		  \include CodeSnippet_jogpars.cpp
	BENCHTOPDCSERVO_API unsigned int __cdecl DBC_GetJogStepSize(char const * serialNo, short channel);
	...
	/// <seealso cref="DBC_MoveJog(char const * serialNo, short channel, MOT_TravelDirection jogDirection)" />
    /// 		  \include CodeSnippet_jogpars.cpp
	BENCHTOPDCSERVO_API short __cdecl DBC_SetJogStepSize(char const * serialNo, short channel, unsigned int stepSize);
	...
	/// <seealso cref="DBC_MoveJog(char const * serialNo, short channel, MOT_TravelDirection jogDirection)" />
    /// 		  \include CodeSnippet_jogpars.cpp
	BENCHTOPDCSERVO_API short __cdecl DBC_GetJogVelParams(char const * serialNo, short channel, int * acceleration, int * maxVelocity);
	...
	/// <seealso cref="DBC_MoveJog(char const * serialNo, short channel, MOT_TravelDirection jogDirection)" />
    /// 		  \include CodeSnippet_jogpars.cpp
	BENCHTOPDCSERVO_API short __cdecl DBC_SetJogVelParams(char const * serialNo, short channel, int acceleration, int maxVelocity);
	...
	BENCHTOPDCSERVO_API short __cdecl DBC_MoveJog(char const * serialNo, short channel, MOT_TravelDirection jogDirection);
	...
	BENCHTOPDCSERVO_API short __cdecl DBC_GetVelParams(char const * serialNo, short channel, int * acceleration, int * maxVelocity);
	...
	/// <seealso cref="DBC_MoveAtVelocity(char const * serialNo, short channel, MOT_TravelDirection direction)" />
    /// 		  \include CodeSnippet_movepars.cpp
	BENCHTOPDCSERVO_API short __cdecl DBC_SetVelParams(char const * serialNo, short channel, int acceleration, int maxVelocity);
	...
	/// <seealso cref="DBC_MoveRelative(char const * serialNo, short channel, int displacement)" />
    /// 		  \include CodeSnippet_move.cpp
	BENCHTOPDCSERVO_API short __cdecl DBC_MoveAtVelocity(char const * serialNo, short channel, MOT_TravelDirection direction);
	...
	BENCHTOPDCSERVO_API short __cdecl DBC_SetDirection(char const * serialNo, short channel, bool reverse);

	/// <summary> Stop the current move immediately (with risk of losing track of position). </summary>
	/// <param name="serialNo">	The controller serial no. </param>
	/// <param name="channel">  The channel (1 to n). </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="DBC_StopProfiled(char const * serialNo, short channel)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_StopImmediate(char const * serialNo, short channel);

	/// <summary> Stop the current move using the current velocity profile. </summary>
	/// <param name="serialNo">	The controller serial no. </param>
	/// <param name="channel">  The channel (1 to n). </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="DBC_StopImmediate(char const * serialNo, short channel)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_StopProfiled(char const * serialNo, short channel);
	...
	/// <seealso cref="DBC_SetBacklash(char const * serialNo, short channel, long distance)" />
	BENCHTOPDCSERVO_API long __cdecl DBC_GetBacklash(char const * serialNo, short channel);
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="DBC_GetBacklash(char const * serialNo, short channel)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_SetBacklash(char const * serialNo, short channel, long distance);
	...
	/// 		  The position counter can also be set using <see cref="DBC_SetPositionCounter(char const * serialNo, short channel, long count)" /> <br />
	/// 		  if homing is not to be perforned</remarks>
	/// <param name="serialNo">	The controller serial no. </param>
	/// <param name="channel">  The channel (1 to n). </param>
	/// <returns> Position count in \ref DeviceUnits_page. </returns>
	/// <seealso cref="DBC_GetPosition(char const * serialNo, short channel)" />
	/// <seealso cref="DBC_SetPositionCounter(char const * serialNo, short channel, long count)" />
	BENCHTOPDCSERVO_API long __cdecl DBC_GetPositionCounter(char const * serialNo, short channel);
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="DBC_GetPositionCounter(char const * serialNo, short channel)" />
	/// <seealso cref="DBC_GetPosition(char const * serialNo, short channel)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_SetPositionCounter(char const * serialNo, short channel, long count);
	...
	/// <seealso cref="DBC_SetEncoderCounter(char const * serialNo, short channel, long count)" />
	BENCHTOPDCSERVO_API long __cdecl DBC_GetEncoderCounter(char const * serialNo, short channel);
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="DBC_GetEncoderCounter(char const * serialNo, short channel)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_SetEncoderCounter(char const * serialNo, short channel, long count);
	...
	/// 					 </list> <remarks> If these are bitwise-ORed with 0x0080 then the limits are swapped. </remarks> </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="DBC_SetLimitSwitchParams(char const * serialNo, short channel, MOT_LimitSwitchModes clockwiseHardwareLimit, MOT_LimitSwitchModes anticlockwiseHardwareLimit, unsigned int clockwisePosition, unsigned int anticlockwisePosition, MOT_LimitSwitchSWModes softLimitMode)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_GetLimitSwitchParams(char const * serialNo, short channel, MOT_LimitSwitchModes * clockwiseHardwareLimit, MOT_LimitSwitchModes * anticlockwiseHardwareLimit, unsigned int * clockwisePosition, unsigned int * anticlockwisePosition, MOT_LimitSwitchSWModes * softLimitMode);
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="DBC_SetLimitSwitchParams(char const * serialNo, short channel, MOT_LimitSwitchModes clockwiseHardwareLimit, MOT_LimitSwitchModes anticlockwiseHardwareLimit, unsigned int clockwisePosition, unsigned int anticlockwisePosition, MOT_LimitSwitchSWModes softLimitMode)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_SetLimitSwitchParams(char const * serialNo, short channel, MOT_LimitSwitchModes clockwiseHardwareLimit, MOT_LimitSwitchModes anticlockwiseHardwareLimit, unsigned int clockwisePosition, unsigned int anticlockwisePosition, MOT_LimitSwitchSWModes softLimitMode);
	...
	/// <seealso cref="DBC_SetLimitsSoftwareApproachPolicy(const char * serialNo, MOT_LimitsSoftwareApproachPolicy limitsSoftwareApproachPolicy)" />
	BENCHTOPDCSERVO_API MOT_LimitsSoftwareApproachPolicy __cdecl DBC_GetSoftLimitMode(char const * serialNo, short channel);
	...
	///							<item><term> Allow all moves, illegal or not. </term><term>3</term></item>
	/// 					 </list> <remarks> If these are bitwise-ORed with 0x0080 then the limits are swapped. </remarks> </param>
	/// <seealso cref="DBC_GetSoftLimitMode(const char * serialNo)" />
	BENCHTOPDCSERVO_API void __cdecl DBC_SetLimitsSoftwareApproachPolicy(char const * serialNo, short channel, MOT_LimitsSoftwareApproachPolicy limitsSoftwareApproachPolicy);
	...
	/// <seealso cref="DBC_MoveAtVelocity(char const * serialNo, short channel, MOT_TravelDirection direction)" />
    /// 		  \include CodeSnippet_movepars.cpp
    BENCHTOPDCSERVO_API short __cdecl DBC_GetVelParamsBlock(char const * serialNo, short channel, MOT_VelocityParameters  *velocityParams);
	...
	/// <seealso cref="DBC_MoveAtVelocity(char const * serialNo, short channel, MOT_TravelDirection direction)" />
    /// 		  \include CodeSnippet_movepars.cpp
	BENCHTOPDCSERVO_API short __cdecl DBC_SetVelParamsBlock(char const * serialNo, short channel, MOT_VelocityParameters *velocityParams);
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="DBC_GetMoveAbsolutePosition(const char * serialNo, short channel)" />
	/// <seealso cref="DBC_MoveAbsolute(const char * serialNo, short channel)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_SetMoveAbsolutePosition(const char * serialNo, short channel, int position);

	/// <summary> Gets the move absolute position. </summary>
	/// <param name="serialNo">	The controller serial no. </param>
	/// <param name="channel"> The channel (1 to n). </param>
	/// <returns> The move absolute position in \ref DeviceUnits_page. </returns>
	/// <seealso cref="DBC_SetMoveAbsolutePosition(const char * serialNo, short channel, int position)" />
	/// <seealso cref="DBC_MoveAbsolute(const char * serialNo, short channel)" />
	BENCHTOPDCSERVO_API int __cdecl DBC_GetMoveAbsolutePosition(const char * serialNo, short channel);
	...
	/// <seealso cref="DBC_SetMoveAbsolutePosition(const char * serialNo, short channel, int position)" />
	/// <seealso cref="DBC_GetMoveAbsolutePosition(const char * serialNo, short channel)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_MoveAbsolute(const char * serialNo, short channel);
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="DBC_GetMoveRelativeDistance(const char * serialNo, short channel)" />
	/// <seealso cref="DBC_MoveRelativeDistance(const char * serialNo, short channel)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_SetMoveRelativeDistance(const char * serialNo, short channel, int distance);

	/// <summary> Gets the move relative distance. </summary>
	/// <param name="serialNo">	The controller serial no. </param>
	/// <param name="channel"> The channel (1 to n). </param>
	/// <returns> The move relative distance in \ref DeviceUnits_page. </returns>
	/// <seealso cref="DBC_SetMoveRelativeDistance(const char * serialNo, short channel, int distance)" />
	/// <seealso cref="DBC_MoveRelativeDistance(const char * serialNo, short channel)" />
	BENCHTOPDCSERVO_API int __cdecl DBC_GetMoveRelativeDistance(const char * serialNo, short channel);
	...
	/// <seealso cref="DBC_SetMoveRelativeDistance(const char * serialNo, short channel, int distance)" />
	/// <seealso cref="DBC_GetMoveRelativeDistance(const char * serialNo, short channel)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_MoveRelativeDistance(const char * serialNo, short channel);
	...
	/// <seealso cref="DBC_SetHomingVelocity(char const * serialNo, short channel, unsigned int velocity)" />
	/// <seealso cref="DBC_SetHomingParamsBlock(char const * serialNo, short channel, MOT_HomingParameters *homingParams)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_GetHomingParamsBlock(char const * serialNo, short channel, MOT_HomingParameters *homingParams);
	...
	/// <seealso cref="DBC_SetHomingVelocity(char const * serialNo, short channel, unsigned int velocity)" />
	/// <seealso cref="DBC_GetHomingParamsBlock(char const * serialNo, short channel, MOT_HomingParameters *homingParams)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_SetHomingParamsBlock(char const * serialNo, short channel, MOT_HomingParameters *homingParams);
	...
	/// <seealso cref="DBC_MoveJog(char const * serialNo, short channel, MOT_TravelDirection jogDirection)" />
    /// 		  \include CodeSnippet_jogpars.cpp
	BENCHTOPDCSERVO_API short __cdecl DBC_GetJogParamsBlock(char const * serialNo, short channel, MOT_JogParameters *jogParams);
	...
	/// <seealso cref="DBC_MoveJog(char const * serialNo, short channel, MOT_TravelDirection jogDirection)" />
    /// 		  \include CodeSnippet_jogpars.cpp
	BENCHTOPDCSERVO_API short __cdecl DBC_SetJogParamsBlock(char const * serialNo, short channel, MOT_JogParameters *jogParams);
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="DBC_SetLimitSwitchParams(char const * serialNo, MOT_LimitSwitchModes clockwiseHardwareLimit, MOT_LimitSwitchModes anticlockwiseHardwareLimit, unsigned int clockwisePosition, unsigned int anticlockwisePosition, MOT_LimitSwitchSWModes softLimitMode)" />
	/// <seealso cref="DBC_GetLimitSwitchParams(char const * serialNo, MOT_LimitSwitchModes * clockwiseHardwareLimit, MOT_LimitSwitchModes * anticlockwiseHardwareLimit, unsigned int * clockwisePosition, unsigned int * anticlockwisePosition, MOT_LimitSwitchSWModes * softLimitMode)" />
	/// <seealso cref="DBC_SetLimitSwitchParamsBlock(const char * serialNo, MOT_LimitSwitchParameters *limitSwitchParams)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_GetLimitSwitchParamsBlock(char const * serialNo, short channel, MOT_LimitSwitchParameters *limitSwitchParams);
	...
	/// <seealso cref="DBC_GetLimitSwitchParams(char const * serialNo, MOT_LimitSwitchModes * clockwiseHardwareLimit, MOT_LimitSwitchModes * anticlockwiseHardwareLimit, unsigned int * clockwisePosition, unsigned int * anticlockwisePosition, MOT_LimitSwitchSWModes * softLimitMode)" />
	/// <seealso cref="DBC_SetLimitSwitchParams(char const * serialNo, MOT_LimitSwitchModes clockwiseHardwareLimit, MOT_LimitSwitchModes anticlockwiseHardwareLimit, unsigned int clockwisePosition, unsigned int anticlockwisePosition, MOT_LimitSwitchSWModes softLimitMode)" />
	/// <seealso cref="DBC_GetLimitSwitchParamsBlock(const char * serialNo, MOT_LimitSwitchParameters *limitSwitchParams)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_SetLimitSwitchParamsBlock(char const * serialNo, short channel, MOT_LimitSwitchParameters *limitSwitchParams);
	...
	/// 				 </list> </returns>
	/// <seealso cref="DBC_SetTriggerSwitches(char const * serialNo, short channel, byte indicatorBits)" />
	BENCHTOPDCSERVO_API byte __cdecl DBC_GetTriggerSwitches(char const * serialNo, short channel);
	...
	/// 					 </list>. </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="DBC_GetTriggerSwitches(char const * serialNo, short channel)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_SetTriggerSwitches(char const * serialNo, short channel, byte indicatorBits);

	/// <summary> Requests the digital output bits. </summary>
	/// <param name="serialNo">	The controller serial no. </param>
	/// <param name="channel">  The channel (1 to n). </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="DBC_SetDigitalOutputs(char const * serialNo, short channel, byte outputsBits)" />
	/// <seealso cref="DBC_GetDigitalOutputs(char const * serialNo, short channel)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_RequestDigitalOutputs(char const * serialNo, short channel);
	...
	/// <seealso cref="DBC_SetDigitalOutputs(char const * serialNo, short channel, byte outputsBits)" />
	/// <seealso cref="DBC_RequestDigitalOutputs(char const * serialNo, short channel)" />
	BENCHTOPDCSERVO_API byte __cdecl DBC_GetDigitalOutputs(char const * serialNo, short channel);
	...
	/// <seealso cref="DBC_GetDigitalOutputs(char const * serialNo, short channel)" />
	/// <seealso cref="DBC_RequestDigitalOutputs(char const * serialNo, short channel)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_SetDigitalOutputs(char const * serialNo, short channel, byte outputsBits);

	/// <summary> Requests the rack digital output bits. </summary>
	/// <param name="serialNo">	The controller serial no. </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="DBC_SetRackDigitalOutputs(char const * serialNo, byte outputsBits)" />
	/// <seealso cref="DBC_GetRackDigitalOutputs(char const * serialNo)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_RequestRackDigitalOutputs(char const * serialNo);

	/// <summary> Gets the rack digital output bits. </summary>
	/// <param name="serialNo">	The controller serial no. </param>
	/// <returns> Bit mask of states of the 4 digital output pins. </returns>
	/// <seealso cref="DBC_SetRackDigitalOutputs(char const * serialNo, byte outputsBits)" />
	/// <seealso cref="DBC_RequestRackDigitalOutputs(char const * serialNo)" />
	BENCHTOPDCSERVO_API byte __cdecl DBC_GetRackDigitalOutputs(char const * serialNo);
	...
	/// <seealso cref="DBC_GetRackDigitalOutputs(char const * serialNo)" />
	/// <seealso cref="DBC_RequestRackDigitalOutputs(char const * serialNo)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_SetRackDigitalOutputs(char const * serialNo, byte outputsBits);
	...
	/// <seealso cref="DBC_GetDigitalOutputs(char const * serialNo, short channel)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_RequestInputVoltage(char const * serialNo, short channel);

	/// <summary> Gets the analogue input voltage reading. </summary>
	/// <param name="serialNo">	The controller serial no. </param>
	/// <param name="channel">  The channel (1 to n). </param>
	/// <returns> The input voltage 0-32768 corresponding to 0-5V. </returns>
	/// <seealso cref="DBC_RequestInputVoltage(char const * serialNo, short channel)" />
	BENCHTOPDCSERVO_API WORD __cdecl DBC_GetInputVoltage(char const * serialNo, short channel);
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="DBC_SetDCPIDParams(const char * serialNo, MOT_DC_PIDParameters *DCproportionalIntegralDifferentialParams)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_GetDCPIDParams(const char * serialNo, MOT_DC_PIDParameters *DCproportionalIntegralDifferentialParams, short channel);

	/// <summary> Set the DC PID parameters. </summary>
	/// <param name="serialNo"> The device serial no. </param>
	/// <param name="channel">  The channel (1 to n). </param>
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="DBC_GetDCPIDParams(const char * serialNo, MOT_DC_PIDParameters *DCproportionalIntegralDifferentialParams)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_SetDCPIDParams(const char * serialNo, MOT_DC_PIDParameters *DCproportionalIntegralDifferentialParams, short channel);
	...
	///// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	///// <seealso cref="DBC_SetJoystickParams(char const * serialNo, short channel, MOT_JoystickParameters *joystickParams)" />
	//BENCHTOPDCSERVO_API short __cdecl DBC_GetJoystickParams(char const * serialNo, short channel, MOT_JoystickParameters *joystickParams);
	...
	///// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	///// <seealso cref="DBC_GetJoystickParams(char const * serialNo, short channel, MOT_JoystickParameters *joystickParams)" />
	//BENCHTOPDCSERVO_API short __cdecl DBC_SetJoystickParams(char const * serialNo, short channel, MOT_JoystickParameters *joystickParams);
	...
	/// <param name="channel">  The channel (1 to n). </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="DBC_ResumeMoveMessages(char const * serialNo, short channel)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_SuspendMoveMessages(char const * serialNo, short channel);

	/// <summary> Resume suspended move messages. </summary>
	/// <param name="serialNo">	The controller serial no. </param>
	/// <param name="channel">  The channel (1 to n). </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="DBC_SuspendMoveMessages(char const * serialNo, short channel)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_ResumeMoveMessages(char const * serialNo, short channel);
	...
	/// 		  NOTE this is called automatically if Polling is enabled for the device using <see cref="DBC_StartPolling(char const * serialNo, short channel, int milliseconds)" />. </remarks>
	/// <param name="serialNo"> The controller serial no. </param>
	/// <param name="channel">  The channel (1 to n). </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successfully requested. </returns>
    /// 		  \include CodeSnippet_move.cpp
	/// <seealso cref="DBC_GetPosition(char const * serialNo, short channel)" />
	/// <seealso cref="DBC_StartPolling(char const * serialNo, short channel, int milliseconds)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_RequestPosition(char const * serialNo, short channel);
	...
	/// <param name="channel">  The channel (1 to n). </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successfully requested. </returns>
	/// <seealso cref="DBC_GetStatusBits(char const * serialNo, short channel)" />
	/// <seealso cref="DBC_StartPolling(char const * serialNo, short channel, int milliseconds)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_RequestStatusBits(char const * serialNo, short channel);

	/// <summary>Get the current status bits. </summary>
	/// <remarks> This returns the latest status bits received from the device.<br />
	/// 		  To get new status bits, use <see cref="DBC_RequestStatusBits(char const * serialNo, short channel)" />
	/// 		  or use the polling functions, <see cref="DBC_StartPolling(char const * serialNo, short channel, int milliseconds)" />.  </remarks>
	/// <param name="channel">  The channel (1 to n). </param>
	/// <param name="serialNo">	The controller serial no. </param>
	...
	/// <seealso cref="DBC_RequestStatusBits(char const * serialNo, short channel)" />
	/// <seealso cref="DBC_StartPolling(char const * serialNo, short channel, int milliseconds)" />
	BENCHTOPDCSERVO_API DWORD __cdecl DBC_GetStatusBits(char const * serialNo, short channel);
	...
	/// <returns> <c>true</c> if successful, false if not. </returns>
	/// <seealso cref="DBC_StopPolling(char const * serialNo, short channel)" />
	/// <seealso cref="DBC_PollingDuration(char const * serialNo, short channel)" />
	/// <seealso cref="DBC_RequestStatusBits(char const * serialNo, short channel)" />
	/// <seealso cref="DBC_RequestPosition(char const * serialNo, short channel)" />
	/// \include CodeSnippet_connectionN.cpp
	BENCHTOPDCSERVO_API bool __cdecl DBC_StartPolling(char const * serialNo, short channel, int milliseconds);
	...
	/// <seealso cref="DBC_StopPolling(char const * serialNo, short channel)" />
	/// \include CodeSnippet_connectionN.cpp
	BENCHTOPDCSERVO_API long __cdecl DBC_PollingDuration(char const * serialNo, short channel);
	...
	/// <seealso cref="DBC_PollingDuration(char const * serialNo, short channel)" />
	/// \include CodeSnippet_connectionN.cpp
	BENCHTOPDCSERVO_API void __cdecl DBC_StopPolling(char const * serialNo, short channel);
	...
	/// <seealso cref="DBC_EnableLastMsgTimer(char const * serialNo, short channel, bool enable, __int32 lastMsgTimeout )" />
	/// <seealso cref="DBC_HasLastMsgTimerOverrun(char const * serialNo, short channel)" />
	/// \include CodeSnippet_connectionMonitoring.cpp
	BENCHTOPDCSERVO_API bool __cdecl DBC_TimeSinceLastMsgReceived(char const * serialNo, short channel, __int64 &lastUpdateTimeMS );
	...
	/// <seealso cref="DBC_TimeSinceLastMsgReceived(char const * serialNo, short channel, __int64 &lastUpdateTimeMS )" />
	/// <seealso cref="DBC_HasLastMsgTimerOverrun(char const * serialNo, short channel)" />
	/// \include CodeSnippet_connectionMonitoring.cpp
	BENCHTOPDCSERVO_API void __cdecl DBC_EnableLastMsgTimer(char const * serialNo, short channel, bool enable, __int32 lastMsgTimeout );

	/// <summary> Queries if the time since the last message has exceeded the lastMsgTimeout set by <see cref="DBC_EnableLastMsgTimer(char const * serialNo, bool enable, __int32 lastMsgTimeout )"/>. </summary>
	/// <remarks> This can be used to determine whether communications with the device is still good</remarks>
	/// <param name="serialNo"> The controller serial no. </param>
	/// <param name="channel"> The channel (1 to n). </param>
	...
	/// <seealso cref="DBC_EnableLastMsgTimer(char const * serialNo, short channel, bool enable, __int32 lastMsgTimeout )" />
	/// \include CodeSnippet_connectionMonitoring.cpp
	BENCHTOPDCSERVO_API bool __cdecl DBC_HasLastMsgTimerOverrun(char const * serialNo, short channel);
	...
	/// <param name="channel">  The channel (1 to n). </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successfully requested. </returns>
	BENCHTOPDCSERVO_API short __cdecl DBC_RequestSettings(char const * serialNo, short channel);

	/// <summary> Gets the DC Servo minimum stage position. </summary>
	/// <param name="serialNo">	The controller serial no. </param>
	/// <param name="channel">  The channel (1 to n). </param>
	/// <returns> The Minimum position in \ref DeviceUnits_page. </returns>
	/// <seealso cref="DBC_SetStageAxisLimits(char const * serialNo, short channel, int minPosition, int maxPosition)" />
	/// <seealso cref="DBC_GetStageAxisMaxPos(char const * serialNo, short channel)" />
	BENCHTOPDCSERVO_API int __cdecl DBC_GetStageAxisMinPos(char const * serialNo, short channel);
	...
	/// <seealso cref="DBC_SetStageAxisLimits(char const * serialNo, short channel, int minPosition, int maxPosition)" />
	/// <seealso cref="DBC_GetStageAxisMinPos(char const * serialNo, short channel)" />
	BENCHTOPDCSERVO_API int __cdecl DBC_GetStageAxisMaxPos(char const * serialNo, short channel);
	...
	/// <seealso cref="DBC_GetStageAxisMinPos(char const * serialNo, short channel)" />
	/// <seealso cref="DBC_GetStageAxisMaxPos(char const * serialNo, short channel)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_SetStageAxisLimits(char const * serialNo, short channel, int minPosition, int maxPosition);
	...
	/// 						  </list> </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="DBC_GetMotorTravelMode(char const * serialNo, short channel)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_SetMotorTravelMode(char const * serialNo, short channel, MOT_TravelModes travelMode);
	...
	///								<item><term>Rotational motion</term><term>2</term></item>
	/// 						  </list> </returns>
	/// <seealso cref="DBC_SetMotorTravelMode(char const * serialNo, short channel, int travelMode)" />
	BENCHTOPDCSERVO_API MOT_TravelModes __cdecl DBC_GetMotorTravelMode(char const * serialNo, short channel);

	/// <summary> Sets the motor stage parameters. </summary>
	/// <remarks> @deprecated superceded by <see cref="DBC_SetMotorParamsExt(char const * serialNo, short channel, double stepsPerRevolution, double gearboxRatio, double pitch)"/> </remarks>
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="DBC_GetMotorParams(char const * serialNo, short channel, long *stepsPerRev, long *gearBoxRatio, float *pitch)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_SetMotorParams(char const * serialNo, short channel, long stepsPerRev, long gearBoxRatio, float pitch);

	/// <summary> Sets the motor stage parameters. </summary>
	/// <remarks> @deprecated superceded by <see cref="DBC_GetMotorParamsExt(char const * serialNo, short channel, double *stepsPerRevolution, double *gearboxRatio, double *pitch)"/> </remarks>
	/// <remarks> These parameters, when combined define the stage motion in terms of \ref RealWorldUnits_page. (mm or degrees)<br />
	/// 		  The real world unit is defined from stepsPerRev * gearBoxRatio / pitch.</remarks>
	/// <param name="serialNo"> The controller serial no. </param>
	/// <param name="channel">  The channel (1 to n). </param>
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="DBC_GetMotorParams(char const * serialNo, short channel, long *stepsPerRev, long *gearBoxRatio, float *pitch)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_GetMotorParams(char const * serialNo, short channel, long *stepsPerRev, long *gearBoxRatio, float *pitch);
	...
	/// <param name="pitch">	    The pitch. </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="DBC_GetMotorParamsExt(char const * serialNo, short channel, long *stepsPerRev, long *gearBoxRatio, float *pitch)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_SetMotorParamsExt(char const * serialNo, short channel, double stepsPerRev, double gearBoxRatio, double pitch);
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="DBC_GetMotorParamsExt(char const * serialNo, short channel, long *stepsPerRev, long *gearBoxRatio, float *pitch)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_GetMotorParamsExt(char const * serialNo, short channel, double *stepsPerRev, double *gearBoxRatio, double *pitch);
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="DBC_GetMotorTravelLimits(char const * serialNo, short channel, double *minPosition, double *maxPosition)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_SetMotorVelocityLimits(char const * serialNo, short channel, double maxVelocity, double maxAcceleration);
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="DBC_SetMotorTravelLimits(char const * serialNo, short channel, double minPosition, double maxPosition)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_GetMotorVelocityLimits(char const * serialNo, short channel, double *maxVelocity, double *maxAcceleration);
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="DBC_GetMotorTravelLimits(char const * serialNo, short channel, double *minPosition, double *maxPosition)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_SetMotorTravelLimits(char const * serialNo, short channel, double minPosition, double maxPosition);
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="DBC_SetMotorTravelLimits(char const * serialNo, short channel, double minPosition, double maxPosition)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_GetMotorTravelLimits(char const * serialNo, short channel, double *minPosition, double *maxPosition);
	...
	/// 						  </list> </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="DBC_GetDeviceUnitFromRealValue(char const * serialNo, short channel, double real_unit, int *device_unit, int unitType)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_GetRealValueFromDeviceUnit(char const * serialNo, short channel, int device_unit, double *real_unit, int unitType);
	...
	/// <seealso cref="DBC_GetRealValueFromDeviceUnit(char const * serialNo, short channel, int device_unit, double *real_unit, int unitType)" />
	BENCHTOPDCSERVO_API short __cdecl DBC_GetDeviceUnitFromRealValue(char const * serialNo, short channel, double real_unit, int *device_unit, int unitType);
}
/** @} */ // BenchtopDCServo
