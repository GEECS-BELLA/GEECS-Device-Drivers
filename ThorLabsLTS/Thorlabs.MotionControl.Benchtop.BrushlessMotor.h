 ...
 */
	...
	/// <param name="channel">  The channel (1 to n). </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="BMC_SetDigitalOutputs(char const * serialNo, byte outputsBits, short channe)" />
	/// <seealso cref="BMC_GetDigitalOutputs(char const * serialNo, short channe)" />
