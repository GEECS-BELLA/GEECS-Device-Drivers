...
<Project Type="Project" LVVersion="20008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="WindmillDevice.lvclass" Type="LVClass" URL="../WindmillDevice.lvclass"/>
		...
		<Item Name="getDeviceList.vi" Type="VI" URL="../SubVis/getDeviceList.vi"/>
		<Item Name="command_center.vi" Type="VI" URL="../SubVis/command_center.vi"/>
		<Item Name="closeDeviceReference.vi" Type="VI" URL="../SubVis/closeDeviceReference.vi"/>
		<Item Name="sendReceiveCommand.vi" Type="VI" URL="../SubVis/sendReceiveCommand.vi"/>
		<Item Name="calc steps.vi" Type="VI" URL="../SubVis/calc steps.vi"/>
		<Item Name="steps to position.vi" Type="VI" URL="../SubVis/steps to position.vi"/>
		<Item Name="Arcus Configure Device Name.vi" Type="VI" URL="../Arcus Configure Device Name.vi"/>
		<Item Name="check device serial number.vi" Type="VI" URL="../SubVis/check device serial number.vi"/>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="getNumDevices.vi" Type="VI" URL="../SubVis/getNumDevices.vi"/>
			<Item Name="errors_actions.ctl" Type="VI" URL="../SubVis/errors_actions.ctl"/>
			<Item Name="errors.vi" Type="VI" URL="../SubVis/errors.vi"/>
			<Item Name="info_options.ctl" Type="VI" URL="../SubVis/info_options.ctl"/>
			<Item Name="getDeviceInfo.vi" Type="VI" URL="../SubVis/getDeviceInfo.vi"/>
			<Item Name="strByteArrayConvert.vi" Type="VI" URL="../SubVis/strByteArrayConvert.vi"/>
			<Item Name="device_selector_panel.vi" Type="VI" URL="../SubVis/device_selector_panel.vi"/>
			<Item Name="device_selector_panel_actions.vi" Type="VI" URL="../SubVis/device_selector_panel_actions.vi"/>
			<Item Name="setTimeOuts.vi" Type="VI" URL="../SubVis/setTimeOuts.vi"/>
			<Item Name="openDeviceReference.vi" Type="VI" URL="../SubVis/openDeviceReference.vi"/>
			<Item Name="commands.ctl" Type="VI" URL="../SubVis/commands.ctl"/>
			<Item Name="command_generator.vi" Type="VI" URL="../SubVis/command_generator.vi"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="WindmillDevice" Type="Source Distribution">
				...
				<Property Name="Bld_previewCacheID" Type="Str">{C1DEBB14-2C1C-4819-82FD-9952028E4503}</Property>
