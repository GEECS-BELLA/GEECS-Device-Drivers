...
def process_data(grid):
    ...
    #df2 = df.iloc[:,[0,36,53,17,18]]
    df2 = df.loc[:,["id","navName","hisEnd","curStatus","curVal"]]
    ...
    #df3 = df3.iloc[:,[0,1,2,4,5,8,3,6,7]]
    ...
    str_array = np.vectorize(str)(df3)
