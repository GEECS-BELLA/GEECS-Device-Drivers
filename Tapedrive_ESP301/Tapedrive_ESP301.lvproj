...
<Project Type="Project" LVVersion="13008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Tapedrive_ESP301.lvclass" Type="LVClass" URL="../Tapedrive_ESP301.lvclass"/>
		<Item Name="Direction.ctl" Type="VI" URL="../Tapedrive_VIs_CK/Direction.ctl"/>
		<Item Name="Status_FGV.vi" Type="VI" URL="../Tapedrive_VIs_CK/Status_FGV.vi"/>
		<Item Name="Status_com.ctl" Type="VI" URL="../Tapedrive_VIs_CK/Status_com.ctl"/>
		<Item Name="spawned_waitstep.vi" Type="VI" URL="../Tapedrive_VIs_CK/spawned_waitstep.vi"/>
		<Item Name="Newport ESP301.lvlib" Type="Library" URL="/&lt;instrlib&gt;/Newport ESP301/Newport ESP301.lvlib"/>
		<Item Name="WaitingFor.ctl" Type="VI" URL="../Tapedrive_VIs_CK/WaitingFor.ctl"/>
		...
		<Item Name="compare config files.vi" Type="VI" URL="../Tapedrive_VIs_CK/compare config files.vi"/>
		<Item Name="generateTrapeze.vi" Type="VI" URL="../SubVis/generateTrapeze.vi"/>
		<Item Name="Untitled 2 (SubVI).vi" Type="VI" URL="../SubVis/Untitled 2 (SubVI).vi"/>
		<Item Name="StopAndWait_SubVi.vi" Type="VI" URL="../SubVis/StopAndWait_SubVi.vi"/>
		<Item Name="CalculateRatio.vi" Type="VI" URL="../SubVis/CalculateRatio.vi"/>
		<Item Name="EnableMotor.vi" Type="VI" URL="../SubVis/EnableMotor.vi"/>
		<Item Name="AnalyzePointing.vi" Type="VI" URL="../SubVis/AnalyzePointing.vi"/>
		<Item Name="SaveImageAndDATA.vi" Type="VI" URL="../SubVis/SaveImageAndDATA.vi"/>
		<Item Name="AnAlyZEPoINting_SuBVi.vi" Type="VI" URL="../SubVis/AnAlyZEPoINting_SuBVi.vi"/>
		<Item Name="StrehlRatio.vi" Type="VI" URL="/Z/USER/Thomas/LabVIEW/Tools/2dGauss/StrehlRatio.vi"/>
		<Item Name="TestProgram_WorkingVersion2012_May.vi" Type="VI" URL="../Tapedrive_VIs_CK/TestProgram_WorkingVersion2012_May.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="instr.lib" Type="Folder">
				<Item Name="Stop Motion.vi" Type="VI" URL="/&lt;instrlib&gt;/Newport ESP301/Public/Motion And Position Control/Stop Motion.vi"/>
				<Item Name="Initialize.vi" Type="VI" URL="/&lt;instrlib&gt;/Newport ESP301/Public/Initialize.vi"/>
				<Item Name="Read Actual Position.vi" Type="VI" URL="/&lt;instrlib&gt;/Newport ESP301/Public/Status/Read Actual Position.vi"/>
				<Item Name="Write Command and Read.vi" Type="VI" URL="/&lt;instrlib&gt;/Newport ESP301/Private/Write Command and Read.vi"/>
				<Item Name="Error Query.vi" Type="VI" URL="/&lt;instrlib&gt;/Newport ESP301/Public/Status/Error Query.vi"/>
				<Item Name="Close.vi" Type="VI" URL="/&lt;instrlib&gt;/Newport ESP301/Public/Close.vi"/>
				<Item Name="Set Master-Slave Reduction Ratio.vi" Type="VI" URL="/&lt;instrlib&gt;/Newport ESP301/Public/Master Slave/Set Master-Slave Reduction Ratio.vi"/>
				<Item Name="Move Relative.vi" Type="VI" URL="/&lt;instrlib&gt;/Newport ESP301/Public/Motion And Position Control/Move Relative.vi"/>
				<Item Name="Set Velocity.vi" Type="VI" URL="/&lt;instrlib&gt;/Newport ESP301/Public/Trajectory/Set Velocity.vi"/>
				<Item Name="Set Acceleration.vi" Type="VI" URL="/&lt;instrlib&gt;/Newport ESP301/Public/Trajectory/Set Acceleration.vi"/>
				<Item Name="Set Deceleration.vi" Type="VI" URL="/&lt;instrlib&gt;/Newport ESP301/Public/Trajectory/Set Deceleration.vi"/>
				<Item Name="Read Actual Velocity.vi" Type="VI" URL="/&lt;instrlib&gt;/Newport ESP301/Public/Status/Read Actual Velocity.vi"/>
				<Item Name="Define Home.vi" Type="VI" URL="/&lt;instrlib&gt;/Newport ESP301/Public/Motion And Position Control/Define Home.vi"/>
				<Item Name="Set Maximum Velocity.vi" Type="VI" URL="/&lt;instrlib&gt;/Newport ESP301/Public/Trajectory/Set Maximum Velocity.vi"/>
				<Item Name="Set Maximum Acceleration and Deceleration.vi" Type="VI" URL="/&lt;instrlib&gt;/Newport ESP301/Public/Trajectory/Set Maximum Acceleration and Deceleration.vi"/>
				<Item Name="Set Velocity Feed-Forward Gain.vi" Type="VI" URL="/&lt;instrlib&gt;/Newport ESP301/Public/Filter/Set Velocity Feed-Forward Gain.vi"/>
				<Item Name="Set Acceleration Feed-Forward Gain.vi" Type="VI" URL="/&lt;instrlib&gt;/Newport ESP301/Public/Filter/Set Acceleration Feed-Forward Gain.vi"/>
				<Item Name="Set DAC Offset.vi" Type="VI" URL="/&lt;instrlib&gt;/Newport ESP301/Public/General Mode Selection/Set DAC Offset.vi"/>
				<Item Name="Enable Disable Motor.vi" Type="VI" URL="/&lt;instrlib&gt;/Newport ESP301/Public/General Mode Selection/Enable Disable Motor.vi"/>
				<Item Name="Define Master Slave Relationship.vi" Type="VI" URL="/&lt;instrlib&gt;/Newport ESP301/Public/Master Slave/Define Master Slave Relationship.vi"/>
				<Item Name="Set Trajectory Mode.vi" Type="VI" URL="/&lt;instrlib&gt;/Newport ESP301/Public/General Mode Selection/Set Trajectory Mode.vi"/>
				<Item Name="Get Master-Slave Relationship.vi" Type="VI" URL="/&lt;instrlib&gt;/Newport ESP301/Public/Master Slave/Get Master-Slave Relationship.vi"/>
				<Item Name="Get Master-Slave Reduction Ratio.vi" Type="VI" URL="/&lt;instrlib&gt;/Newport ESP301/Public/Master Slave/Get Master-Slave Reduction Ratio.vi"/>
				<Item Name="Get Master-Slave Velocity Update Interval.vi" Type="VI" URL="/&lt;instrlib&gt;/Newport ESP301/Public/Master Slave/Get Master-Slave Velocity Update Interval.vi"/>
				<Item Name="Get Motor Power Status.vi" Type="VI" URL="/&lt;instrlib&gt;/Newport ESP301/Public/General Mode Selection/Get Motor Power Status.vi"/>
				<Item Name="Move Indefinitely.vi" Type="VI" URL="/&lt;instrlib&gt;/Newport ESP301/Public/Motion And Position Control/Move Indefinitely.vi"/>
			</Item>
			...
			<Item Name="Stop Motion.vi" Type="VI" URL="../Newport ESP301/Public/Motion And Position Control/Stop Motion.vi"/>
			<Item Name="Read Actual Position.vi" Type="VI" URL="../Newport ESP301/Public/Status/Read Actual Position.vi"/>
			<Item Name="Get Motor Power Status_CK.vi" Type="VI" URL="../Tapedrive_VIs_CK/Get Motor Power Status_CK.vi"/>
			<Item Name="Get Velocity_CK.vi" Type="VI" URL="../Tapedrive_VIs_CK/Get Velocity_CK.vi"/>
			<Item Name="Get Acceleration_CK.vi" Type="VI" URL="../Tapedrive_VIs_CK/Get Acceleration_CK.vi"/>
			<Item Name="Get Deceleration_CK.vi" Type="VI" URL="../Tapedrive_VIs_CK/Get Deceleration_CK.vi"/>
			<Item Name="Get Maximum Velocity_CK.vi" Type="VI" URL="../Tapedrive_VIs_CK/Get Maximum Velocity_CK.vi"/>
			<Item Name="Get Maximum Acceleration and Deceleration_CK.vi" Type="VI" URL="../Tapedrive_VIs_CK/Get Maximum Acceleration and Deceleration_CK.vi"/>
			<Item Name="Get Velocity Feed-Forward Gain_CK.vi" Type="VI" URL="../Tapedrive_VIs_CK/Get Velocity Feed-Forward Gain_CK.vi"/>
			<Item Name="Get Acceleration Feed-Forward Gain_CK.vi" Type="VI" URL="../Tapedrive_VIs_CK/Get Acceleration Feed-Forward Gain_CK.vi"/>
			<Item Name="Get DAC Offset_CK.vi" Type="VI" URL="../Tapedrive_VIs_CK/Get DAC Offset_CK.vi"/>
			<Item Name="StopFGV.vi" Type="VI" URL="../../../Interface/shared/StopFGV.vi"/>
			<Item Name="ConnectionFGV.vi" Type="VI" URL="../../../Interface/shared/ConnectionFGV.vi"/>
			<Item Name="WaitFGV.vi" Type="VI" URL="../../../Interface/shared/WaitFGV.vi"/>
			<Item Name="DATAStringFGV.vi" Type="VI" URL="../../../Interface/shared/DATAStringFGV.vi"/>
			<Item Name="StatusDataConnectionFGV.vi" Type="VI" URL="../../../Interface/shared/StatusDataConnectionFGV.vi"/>
			<Item Name="ConnectionIDsFGV.vi" Type="VI" URL="../../../Interface/shared/ConnectionIDsFGV.vi"/>
			<Item Name="DataConnection.vi" Type="VI" URL="../../../Interface/shared/DataConnection.vi"/>
			<Item Name="getPortAndIP.vi" Type="VI" URL="../../../Interface/GUI_Cameras/getPortAndIP.vi"/>
			<Item Name="getVarNamesGUI.vi" Type="VI" URL="../../../Interface/shared/getVarNamesGUI.vi"/>
			<Item Name="updateInicatorsMainVi.vi" Type="VI" URL="../../../Interface/GUI_Template/updateInicatorsMainVi.vi"/>
			<Item Name="stop.vi" Type="VI" URL="../../../Interface/GUI_Template/stop.vi"/>
			<Item Name="Close UDP AND TCP connections.vi" Type="VI" URL="../../../Interface/GUI_Cameras/Close UDP AND TCP connections.vi"/>
			<Item Name="ClearBufferFGV.vi" Type="VI" URL="../../../Interface/shared/ClearBufferFGV.vi"/>
			<Item Name="StatusImageConnectionFGV.vi" Type="VI" URL="../../../Interface/shared/StatusImageConnectionFGV.vi"/>
			<Item Name="ImageConnection.vi" Type="VI" URL="../../../Interface/shared/ImageConnection.vi"/>
			<Item Name="Get Axis Motion Status_CK.vi" Type="VI" URL="../Tapedrive_VIs_CK/Get Axis Motion Status_CK.vi"/>
			...
			<Item Name="getSalveMaster.vi" Type="VI" URL="../SubVis/getSalveMaster.vi"/>
			...
			<Item Name="Direction_TypDef.ctl" Type="VI" URL="../../TapeDrive/Direction_TypDef.ctl"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="Tapedrive_ESP301" Type="Source Distribution">
				<Property Name="Bld_buildCacheID" Type="Str">{41E0F640-F1CA-4BB7-AE61-94C39B56088F}</Property>
				<Property Name="Bld_buildSpecName" Type="Str">Tapedrive_ESP301</Property>
				...
				<Property Name="Bld_previewCacheID" Type="Str">{2E1BFA99-0F9B-4302-88B5-4C760307D5D1}</Property>
				...
				<Property Name="Source[0].itemID" Type="Str">{088067D5-1CAD-428F-ADF7-7DA34F4960D2}</Property>
				<Property Name="Source[0].type" Type="Str">Container</Property>
				<Property Name="Source[1].destinationIndex" Type="Int">0</Property>
				<Property Name="Source[1].itemID" Type="Ref">/My Computer/Tapedrive_ESP301.lvclass</Property>
