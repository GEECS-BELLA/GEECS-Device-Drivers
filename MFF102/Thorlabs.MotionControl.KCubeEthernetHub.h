...
// from a DLL simpler. All files within this DLL are compiled with the KCUBEETHERNETHUBDLL_EXOPRTS
...
#ifdef KCUBEETHERNETHUBDLL_EXPORTS
#define KCUBEETHERNETHUB_API __declspec(dllexport)
#else
#define KCUBEETHERNETHUB_API __declspec(dllimport)
#endif
...
extern "C"
{
	...
	/// <summary> Values that represent ethernet configuration. </summary>
	typedef enum KEH_EthernetConfiguration : short
	{
		KEH_StaticIpSet = 0x00,
		KEH_DHCPIpSet = 0x01,
		KEH_IpV4AddressSet = 0x02,
		KEH_IpV6AddressSet = 0x03,
	} KEH_EthernetConfiguration;

	/// <summary> Values that represent ethernet status. </summary>
	typedef enum KEH_EthernetStatus : short
	{
		KEH_EthernetPresent = 0x01,
		KEH_EthernetSetupError = 0x02,
		KEH_DHCPIpAvailable = 0x04,
		KEH_StaticIpAvailable = 0x08,
		KEH_DHCPSet = 0x10,
		KEH_IpV6Available = 0x20,
		KEH_IpV6Set = 0x40,
		KEH_DefaultGatewayUsed = 0x80,
	} KEH_EthernetStatus;
	/// \endcond
...
#pragma pack(1)
	...
	typedef struct KEH_EthernetInfo
	{
		/// <summary> The ethernet status. </summary>
		KEH_EthernetStatus Status;
		/// <summary> The MAC address. </summary>
		byte MACAddress[8];
	} KEH_EthernetInfo;

	typedef struct KEH_EthernetParams
	{
		/// <summary> The ethernet configuration. </summary>
		KEH_EthernetConfiguration  EthernetConfiguration;
		/// <summary> The DHCP IPv6 Address. </summary>
		byte DhcpIpV6Address[16];
		/// <summary> The DHCP IPv4 Address. </summary>
		byte DhcpIpV4Address[4];
		/// <summary> The DHCP subnet mask. </summary>
		byte DhcpSubnetMask[4];
		/// <summary> The DHCP default gateway. </summary>
		byte DhcpDefaultGateway[4];
		/// <summary> The Static IPv6 Address. </summary>
		byte StaticIpV6Address[16];
		/// <summary> The Static IPv4 Address. </summary>
		byte StaticIpV4Address[4];
		/// <summary> The Static subnet mask. </summary>
		byte StaticSubnetMask[4];
		/// <summary> The static default gateway. </summary>
		byte StaticDefaulGateway[4];
	}; KEH_EthernetParams;
	#pragma pack()
	...
	/// <seealso cref="TLI_GetDeviceListByTypesExt(char *receiveBuffer, DWORD sizeOfBuffer, int * typeIDs, int length)" />
		KCUBEETHERNETHUB_API short __cdecl TLI_BuildDeviceList(void);
		...
		/// <seealso cref="TLI_GetDeviceListByTypeExt(char *receiveBuffer, DWORD sizeOfBuffer, int typeID)" />
		/// <seealso cref="TLI_GetDeviceListByTypesExt(char *receiveBuffer, DWORD sizeOfBuffer, int * typeIDs, int length)" />
		KCUBEETHERNETHUB_API short __cdecl TLI_GetDeviceListSize();
		...
		/// <seealso cref="TLI_GetDeviceListByTypeExt(char *receiveBuffer, DWORD sizeOfBuffer, int typeID)" />
		/// <seealso cref="TLI_GetDeviceListByTypesExt(char *receiveBuffer, DWORD sizeOfBuffer, int * typeIDs, int length)" />
		KCUBEETHERNETHUB_API short __cdecl TLI_GetDeviceList(SAFEARRAY** stringsReceiver);
		...
		/// <seealso cref="TLI_GetDeviceListByTypeExt(char *receiveBuffer, DWORD sizeOfBuffer, int typeID)" />
		/// <seealso cref="TLI_GetDeviceListByTypesExt(char *receiveBuffer, DWORD sizeOfBuffer, int * typeIDs, int length)" />
		KCUBEETHERNETHUB_API short __cdecl TLI_GetDeviceListByType(SAFEARRAY** stringsReceiver, int typeID);
		...
		/// <seealso cref="TLI_GetDeviceListByTypeExt(char *receiveBuffer, DWORD sizeOfBuffer, int typeID)" />
		/// <seealso cref="TLI_GetDeviceListByTypesExt(char *receiveBuffer, DWORD sizeOfBuffer, int * typeIDs, int length)" />
		KCUBEETHERNETHUB_API short __cdecl TLI_GetDeviceListByTypes(SAFEARRAY** stringsReceiver, int* typeIDs, int length);
		...
		/// <seealso cref="TLI_GetDeviceListByTypeExt(char *receiveBuffer, DWORD sizeOfBuffer, int typeID)" />
		/// <seealso cref="TLI_GetDeviceListByTypesExt(char *receiveBuffer, DWORD sizeOfBuffer, int * typeIDs, int length)" />
		KCUBEETHERNETHUB_API short __cdecl TLI_GetDeviceListExt(char* receiveBuffer, DWORD sizeOfBuffer);
		...
		/// <seealso cref="TLI_GetDeviceListExt(char *receiveBuffer, DWORD sizeOfBuffer)" />
		/// <seealso cref="TLI_GetDeviceListByTypesExt(char *receiveBuffer, DWORD sizeOfBuffer, int * typeIDs, int length)" />
		KCUBEETHERNETHUB_API short __cdecl TLI_GetDeviceListByTypeExt(char* receiveBuffer, DWORD sizeOfBuffer, int typeID);
		...
		/// <seealso cref="TLI_GetDeviceListExt(char *receiveBuffer, DWORD sizeOfBuffer)" />
		/// <seealso cref="TLI_GetDeviceListByTypeExt(char *receiveBuffer, DWORD sizeOfBuffer, int typeID)" />
		KCUBEETHERNETHUB_API short __cdecl TLI_GetDeviceListByTypesExt(char* receiveBuffer, DWORD sizeOfBuffer, int* typeIDs, int length);
		...
		/// <seealso cref="TLI_GetDeviceListByTypeExt(char *receiveBuffer, DWORD sizeOfBuffer, int typeID)" />
		/// <seealso cref="TLI_GetDeviceListByTypesExt(char *receiveBuffer, DWORD sizeOfBuffer, int * typeIDs, int length)" />
		KCUBEETHERNETHUB_API short __cdecl TLI_GetDeviceInfo(char const* serialNo, TLI_DeviceInfo* info);
		...
		/// <seealso cref="TLI_BuildDeviceList()" />
		/// <seealso cref="TLI_GetDeviceList(SAFEARRAY** stringsReceiver)" />
		KCUBEETHERNETHUB_API void __cdecl TLI_InitializeSimulations();
		...
		KCUBEETHERNETHUB_API void __cdecl TLI_UninitializeSimulations();

		/// <summary> Open the device for communications. </summary>
		/// <param name="serialNo">	The serial no of the device to be connected. </param>
		/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
		/// 		  \include CodeSnippet_connectionN.cpp
		/// <seealso cref="KEH_Close(char const * serialNo)" />
		KCUBEETHERNETHUB_API short __cdecl KEH_Open(char const* serialNo);

		/// <summary> Disconnect and close the device. </summary>
		/// <param name="serialNo">	The serial no of the device to be disconnected. </param>
		/// 		  \include CodeSnippet_connectionN.cpp
		/// <seealso cref="KEH_Open(char const * serialNo)" />
		KCUBEETHERNETHUB_API void __cdecl KEH_Close(char const* serialNo);
		...
		KCUBEETHERNETHUB_API bool __cdecl KEH_CheckConnection(char const* serialNo);

		/// <summary> Sends a command to the device to make it identify iteself. </summary>
		/// <param name="serialNo">	The device serial no. </param>
		KCUBEETHERNETHUB_API void __cdecl KEH_Identify(char const* serialNo);

		/// <summary> Tells the device that it is being disconnected. </summary>
		/// <remarks> This does not disconnect the communications.<br />
		/// 		  To disconnect the communications, call the <see cref="KEH_Close(char const * serialNo)" /> function. </remarks>
		/// <param name="serialNo">	The device serial no. </param>
		/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
		KCUBEETHERNETHUB_API short __cdecl KEH_Disconnect(char const* serialNo);
		...
		KCUBEETHERNETHUB_API short __cdecl KEH_GetHardwareInfo(char const* serialNo, char* modelNo, DWORD sizeOfModelNo, WORD* type, WORD* numChannels,
		...
		/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
		/// 		  \include CodeSnippet_identify.cpp
		KCUBEETHERNETHUB_API short __cdecl KEH_GetHardwareInfoBlock(char const* serialNo, TLI_HardwareInformation* hardwareInfo);
		...
		/// 		  \include CodeSnippet_identify.cpp
		KCUBEETHERNETHUB_API DWORD __cdecl KEH_GetFirmwareVersion(char const* serialNo);
		...
		/// 		  \include CodeSnippet_identify.cpp
		KCUBEETHERNETHUB_API DWORD __cdecl KEH_GetSoftwareVersion(char const* serialNo);

		/// <summary> Update device with stored settings. </summary>
		/// <param name="serialNo"> The device serial no. </param>
		/// <returns> <c>true</c> if successful, false if not. </returns>
		/// 		  \include CodeSnippet_connection1.cpp
		KCUBEETHERNETHUB_API bool __cdecl KEH_LoadSettings(char const* serialNo);
		...
		/// <returns> <c>true</c> if successful, false if not. </returns>
		///             \include CodeSnippet_connection1.cpp
		KCUBEETHERNETHUB_API bool __cdecl KEH_LoadNamedSettings(char const* serialNo, char const* settingsName);

		/// <summary> Persist the devices current settings. </summary>
		/// <param name="serialNo">	The device serial no. </param>
		/// <returns> <c>true</c> if successful, false if not. </returns>
		KCUBEETHERNETHUB_API bool __cdecl KEH_PersistSettings(char const* serialNo);

		/// <summary> Reset parameters. </summary>
		/// <param name="serialNo"> The serial no. </param>
		/// <returns> True if it succeeds, false if it fails. </returns>
		KCUBEETHERNETHUB_API short __cdecl KEH_ResetParameters(char const* serialNo);
		...
		/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
		KCUBEETHERNETHUB_API short __cdecl KEH_RegisterMessageCallback(char const* serialNo, void (*functionPointer)());

		/// <summary> Gets the MessageQueue size. </summary>
		/// <remarks> see \ref C_MESSAGES_page "Device Messages" for details on how to use messages. </remarks>
		/// <param name="serialNo"> The device serial no. </param>
		/// <returns> number of messages in the queue. </returns>
		KCUBEETHERNETHUB_API int __cdecl KEH_MessageQueueSize(char const* serialNo);

		/// <summary> Clears the device message queue. </summary>
		/// <remarks> see \ref C_MESSAGES_page "Device Messages" for details on how to use messages. </remarks>
		/// <param name="serialNo"> The device serial no. </param>
		/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
		KCUBEETHERNETHUB_API short __cdecl KEH_ClearMessageQueue(char const* serialNo);
		...
		/// <returns> <c>true</c> if successful, false if not. </returns>
		KCUBEETHERNETHUB_API bool __cdecl KEH_GetNextMessage(char const* serialNo, WORD* messageType, WORD* messageID, DWORD* messageData);
		...
		/// <param name="messageData"> Address of the DWORD to receive the messageData. </param>
		/// <returns> <c>true</c> if successful, false if not. </returns>
		KCUBEETHERNETHUB_API bool __cdecl KEH_WaitForMessage(char const* serialNo, WORD* messageType, WORD* messageID, DWORD* messageData);
		...
		/// <returns> <c>true</c> if successful, false if not. </returns>
		/// <seealso cref="KEH_StopPolling(char const * serialNo)" />
		/// <seealso cref="KEH_PollingDuration(char const * serialNo)" />
		/// <seealso cref="KEH_RequestStatusBits(char const * serialNo)" />
		/// <seealso cref="KEH_RequestPosition(char const * serialNo)" />
		/// \include CodeSnippet_connectionN.cpp
		KCUBEETHERNETHUB_API bool __cdecl KEH_StartPolling(char const* serialNo, int milliseconds);
		...
		/// <seealso cref="KEH_StartPolling(char const * serialNo, int milliseconds)" />
		/// <seealso cref="KEH_StopPolling(char const * serialNo)" />
		/// \include CodeSnippet_connectionN.cpp
		KCUBEETHERNETHUB_API long __cdecl KEH_PollingDuration(char const* serialNo);
		...
		/// <seealso cref="KEH_PollingDuration(char const * serialNo)" />
		/// \include CodeSnippet_connectionN.cpp
		KCUBEETHERNETHUB_API void __cdecl KEH_StopPolling(char const* serialNo);
		...
		/// <seealso cref="KEH_EnableLastMsgTimer(char const * serialNo, bool enable, __int32 lastMsgTimeout )" />
		/// <seealso cref="KEH_HasLastMsgTimerOverrun(char const * serialNo)" />
		/// \include CodeSnippet_connectionMonitoring.cpp
		KCUBEETHERNETHUB_API bool __cdecl KEH_TimeSinceLastMsgReceived(char const* serialNo, __int64& lastUpdateTimeMS);
		...
		/// <seealso cref="KEH_TimeSinceLastMsgReceived(char const * serialNo, __int64 &lastUpdateTimeMS )" />
		/// <seealso cref="KEH_HasLastMsgTimerOverrun(char const * serialNo)" />
		/// \include CodeSnippet_connectionMonitoring.cpp
		KCUBEETHERNETHUB_API void __cdecl KEH_EnableLastMsgTimer(char const* serialNo, bool enable, __int32 lastMsgTimeout);

		/// <summary> Queries if the time since the last message has exceeded the lastMsgTimeout set by <see cref="KEH_EnableLastMsgTimer(char const * serialNo, bool enable, __int32 lastMsgTimeout )"/>. </summary>
		/// <remarks> This can be used to determine whether communications with the device is still good</remarks>
		/// <param name="serialNo"> The device serial no. </param>
		...
		/// <seealso cref="KEH_EnableLastMsgTimer(char const * serialNo, bool enable, __int32 lastMsgTimeout )" />
		/// \include CodeSnippet_connectionMonitoring.cpp
		KCUBEETHERNETHUB_API bool __cdecl KEH_HasLastMsgTimerOverrun(char const* serialNo);
		...
		KCUBEETHERNETHUB_API short __cdecl KEH_RequestSettings(char const* serialNo);

		/// <summary> Requests the ethernet information. </summary>
		/// <param name="serialNo">	The device serial no. </param>
		/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
		/// <seealso cref="KEH_GetEthernetInfo(char const* serialNo, KEH_EthernetInfo* ethernetInfo)" />
		KCUBEETHERNETHUB_API short __cdecl KEH_RequestEthernetInfo(char const* serialNo);

		/// <summary> Get the ethernet information block. </summary>
		/// <param name="serialNo">	The device serial no. </param>
		/// <param name="ethernetInfo">	The ethernet information. </param>
		/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
		/// <seealso cref="KEH_RequestEthernetInfo(char const* serialNo)" />
		KCUBEETHERNETHUB_API short __cdecl KEH_GetEthernetInfo(char const* serialNo, KEH_EthernetInfo* ethernetInfo);

		/// <summary> Requests the ethernet parameters. </summary>
		/// <param name="serialNo">	The device serial no. </param>
		/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
		/// <seealso cref="KEH_GetEthernetParams(char const * serialNo, KEH_EthernetParams *params)" />
		/// <seealso cref="KEH_SetEthernetParams(char const * serialNo, KEH_EthernetParams *params)" />
		KCUBEETHERNETHUB_API short __cdecl KEH_RequestEthernetParams(char const* serialNo);

		/// <summary> Get the ethernet parameters block. </summary>
		/// <param name="serialNo">	The device serial no. </param>
		/// <param name="params">	The ethernet params. </param>
		/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
		/// <seealso cref="KEH_RequestEthernetParams(char const * serialNo)" />
		/// <seealso cref="KEH_SetEthernetParams(char const * serialNo, KEH_EthernetParams *params)" />
		KCUBEETHERNETHUB_API short __cdecl KEH_GetEthernetParams(char const* serialNo, KEH_EthernetParams* params);

		/// <summary> Set the ethernet parameters block. </summary>
		/// <param name="serialNo">	The device serial no. </param>
		/// <param name="params">	The ethernet params. </param>
		/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
		/// <seealso cref="KEH_RequestEthernetParams(char const * serialNo)" />
		/// <seealso cref="KEH_GetEthernetParams(char const * serialNo, KEH_EthernetParams *params)" />
		KCUBEETHERNETHUB_API short __cdecl KEH_SetEthernetParams(char const* serialNo, KEH_EthernetParams* params);

		/// <summary> Request the LED on or off. </summary>
		/// <param name="serialNo"> The serial no. </param>
		/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
		/// <seealso cref="KEH_GetLEDswitches(char const * serialNo)" />
		/// <seealso cref="KEH_SetLEDswitches(char const * serialNo, WORD LEDswitches)" />
		KCUBEETHERNETHUB_API short __cdecl KEH_RequestLEDswitches(char const* serialNo);

		/// <summary> Get the LED on or off. </summary>
		/// <param name="serialNo">	The device serial no. </param>
		/// <returns> 0 to off 1 to on. </returns>
		/// <seealso cref="KEH_RequestLEDswitches(char const * serialNo)" />
		/// <seealso cref="KEH_SetLEDswitches(char const * serialNo, WORD LEDswitches)" />
		KCUBEETHERNETHUB_API WORD __cdecl KEH_GetLEDswitches(char const* serialNo);

		/// <summary> Set the LED on or off. </summary>
		/// <param name="serialNo">	The device serial no. </param>
		/// <param name="LEDswitches"> 0 to off 1 to on. </param>
		/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
		/// <seealso cref="KEH_RequestLEDswitches(char const * serialNo)" />
		/// <seealso cref="KEH_GetLEDswitches(char const * serialNo)" />
		KCUBEETHERNETHUB_API short __cdecl KEH_SetLEDswitches(char const* serialNo, WORD LEDswitches);

		/// <summary> Get the bays count. </summary>
		/// <param name="serialNo">	The device serial no. </param>
		/// <returns> Numbers of bays from 0 to 6. </returns>
		KCUBEETHERNETHUB_API int __cdecl KEH_GetBaysCount(char const* serialNo);
	}
}
/** @} */ // KCube Ethernet Hub
