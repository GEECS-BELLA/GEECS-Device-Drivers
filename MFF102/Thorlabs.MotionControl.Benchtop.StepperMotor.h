...
/// \cond NOT_MASTER
	...
	/// <summary> Values that represent BSC20x Stage Type Idents. </summary>
	typedef enum class BSC_Stages : short
	{
		Unknown = 0x00,
		DRV001 = 0x49,
		DRV013 = 0x50,
...
/// \endcond
	...
	/// 		 <list type=table>
	/// 		<item><term>0x00</term><term>Unknown.</term></item>
	///			<item><term>0x49</term><term>DRV001.</term></item>
	///			<item><term>0x50</term><term>DRV013.</term></item>
	///			<item><term>0x51</term><term>DRV014.</term></item>
	///			<item><term>0xB2</term><term>DRV208.</term></item>
	/// 		<item><term>0xB0</term><term>DRV225.</term></item>
	/// 		<item><term>0xB1</term><term>DRV250.</term></item>
	/// 		<item><term>0xB6</term><term>FW103.</term></item>
	/// 		<item><term>0xAF</term><term>HDR50.</term></item>
	/// 		<item><term>0xB5</term><term>HS_NanoRotator.</term></item>
	/// 		<item><term>0xB7</term><term>LNR50SE.</term></item>
	///  		<item><term>0xB8</term><term>LPX_X.</term></item>
	///  		<item><term>0xB9</term><term>Nanomax300.</term></item>
	///  		<item><term>0xB3</term><term>NTR100.</term></item>
	///  		<item><term>0xB4</term><term>NTR150.</term></item>
	/// 		  </list></param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	BENCHTOPSTEPPERMOTOR_API short __cdecl SBC_SetStageType(char const* serialNo, short channel, BSC_Stages stageId);
}
/** @} */ // BenchtopStepper