...
<Project Type="Project" LVVersion="20008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="kepco.llb" Type="Folder">
			<Item Name="KepcoBOP Configure External Refernces .vi" Type="VI" URL="../kepco.llb/KepcoBOP Configure External Refernces .vi"/>
			<Item Name="KepcoDCPwr Abort [TRG].vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Abort [TRG].vi"/>
			<Item Name="KepcoDCPwr Clear All Lists.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Clear All Lists.vi"/>
			<Item Name="KepcoDCPwr Close.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Close.vi"/>
			<Item Name="KepcoDCPwr Configure Both Voltage Limits.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Configure Both Voltage Limits.vi"/>
			<Item Name="KepcoDCPwr Configure Both Voltage Protect Limits.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Configure Both Voltage Protect Limits.vi"/>
			<Item Name="KepcoDCPwr Configure Current Both Protect Levels.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Configure Current Both Protect Levels.vi"/>
			<Item Name="KepcoDCPwr Configure Current Level.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Configure Current Level.vi"/>
			<Item Name="KepcoDCPwr Configure Current Limit.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Configure Current Limit.vi"/>
			<Item Name="KepcoDCPwr Configure Current Mode.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Configure Current Mode.vi"/>
			<Item Name="KepcoDCPwr Configure Current Protect Level.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Configure Current Protect Level.vi"/>
			<Item Name="KepcoDCPwr Configure List Angle.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Configure List Angle.vi"/>
			<Item Name="KepcoDCPwr Configure List Count.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Configure List Count.vi"/>
			<Item Name="KepcoDCPwr Configure List.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Configure List.vi"/>
			<Item Name="KepcoDCPwr Configure Output Enabled.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Configure Output Enabled.vi"/>
			<Item Name="KepcoDCPwr Configure Output Mode.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Configure Output Mode.vi"/>
			<Item Name="KepcoDCPwr Configure Output State.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Configure Output State.vi"/>
			<Item Name="KepcoDCPwr Configure OVP.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Configure OVP.vi"/>
			<Item Name="KepcoDCPwr Configure Trigger Source [TRG].vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Configure Trigger Source [TRG].vi"/>
			<Item Name="KepcoDCPwr Configure Triggered Current Level [TRG].vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Configure Triggered Current Level [TRG].vi"/>
			<Item Name="KepcoDCPwr Configure Triggered Voltage Level [TRG].vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Configure Triggered Voltage Level [TRG].vi"/>
			<Item Name="KepcoDCPwr Configure User Sequence.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Configure User Sequence.vi"/>
			<Item Name="KepcoDCPwr Configure Voltage Level.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Configure Voltage Level.vi"/>
			<Item Name="KepcoDCPwr Configure Voltage Limit.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Configure Voltage Limit.vi"/>
			<Item Name="KepcoDCPwr Configure Voltage Mode.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Configure Voltage Mode.vi"/>
			<Item Name="KepcoDCPwr Configure Voltage Protect Level.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Configure Voltage Protect Level.vi"/>
			<Item Name="KepcoDCPwr Configure Waveform Apply.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Configure Waveform Apply.vi"/>
			<Item Name="KepcoDCPwr Disable.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Disable.vi"/>
			<Item Name="KepcoDCPwr Error-Query.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Error-Query.vi"/>
			<Item Name="KepcoDCPwr Initialize With Options.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Initialize With Options.vi"/>
			<Item Name="KepcoDCPwr Initialize.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Initialize.vi"/>
			<Item Name="KepcoDCPwr Initiate [TRG].vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Initiate [TRG].vi"/>
			<Item Name="KepcoDCPwr Measure [MSR].vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Measure [MSR].vi"/>
			<Item Name="KepcoDCPwr Query Current Limit.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Query Current Limit.vi"/>
			<Item Name="KepcoDCPwr Query Current Unit Protect Limit.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Query Current Unit Protect Limit.vi"/>
			<Item Name="KepcoDCPwr Query Dwell Count.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Query Dwell Count.vi"/>
			<Item Name="KepcoDCPwr Query Output Enabled.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Query Output Enabled.vi"/>
			<Item Name="KepcoDCPwr Query Output State.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Query Output State.vi"/>
			<Item Name="KepcoDCPwr Query Voltage Limit.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Query Voltage Limit.vi"/>
			<Item Name="KepcoDCPwr Query Voltage Mode.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Query Voltage Mode.vi"/>
			<Item Name="KepcoDCPwr Query Voltage Protect Limit.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Query Voltage Protect Limit.vi"/>
			<Item Name="KepcoDCPwr Query Voltage Protect Unit Limit.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Query Voltage Protect Unit Limit.vi"/>
			<Item Name="KepcoDCPwr Query Voltage Unit Protect Limit.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Query Voltage Unit Protect Limit.vi"/>
			<Item Name="KepcoDCPwr Read Instrument Data.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Read Instrument Data.vi"/>
			<Item Name="KepcoDCPwr Reset Output Protection.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Reset Output Protection.vi"/>
			<Item Name="KepcoDCPwr Reset with Defaults.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Reset with Defaults.vi"/>
			<Item Name="KepcoDCPwr Reset.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Reset.vi"/>
			<Item Name="KepcoDCPwr Self-Test.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Self-Test.vi"/>
			<Item Name="KepcoDCPwr Send Software Trigger [TRG].vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Send Software Trigger [TRG].vi"/>
			<Item Name="KepcoDCPwr transient.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr transient.vi"/>
			<Item Name="KepcoDCPwr Write Instrument Data.vi" Type="VI" URL="../kepco.llb/KepcoDCPwr Write Instrument Data.vi"/>
		</Item>
		<Item Name="KpDcpwr" Type="Folder">
			<Item Name="Utilities" Type="Folder">
				<Item Name="Coerce Input.vi" Type="VI" URL="../KpDcpwr/Utilities/Coerce Input.vi"/>
				<Item Name="Graph Ramp.vi" Type="VI" URL="../KpDcpwr/Utilities/Graph Ramp.vi"/>
				<Item Name="Kepco DC IDN Parser.vi" Type="VI" URL="../KpDcpwr/Utilities/Kepco DC IDN Parser.vi"/>
				<Item Name="KepcoDCPwr Max Number of Points.vi" Type="VI" URL="../KpDcpwr/Utilities/KepcoDCPwr Max Number of Points.vi"/>
				<Item Name="KepcoDCPwr Revision Query.vi" Type="VI" URL="../KpDcpwr/Utilities/KepcoDCPwr Revision Query.vi"/>
				<Item Name="Parse Error Response.vi" Type="VI" URL="../KpDcpwr/Utilities/Parse Error Response.vi"/>
				<Item Name="Recognize Model.vi" Type="VI" URL="../KpDcpwr/Utilities/Recognize Model.vi"/>
				<Item Name="Restrict Input Range.vi" Type="VI" URL="../KpDcpwr/Utilities/Restrict Input Range.vi"/>
				<Item Name="Serial Data clean.vi" Type="VI" URL="../KpDcpwr/Utilities/Serial Data clean.vi"/>
				<Item Name="Set Limits.vi" Type="VI" URL="../KpDcpwr/Utilities/Set Limits.vi"/>
				<Item Name="VS Compute Waveform.vi" Type="VI" URL="../KpDcpwr/Utilities/VS Compute Waveform.vi"/>
			</Item>
			<Item Name="Execute Transient.vi" Type="VI" URL="../KpDcpwr/Execute Transient.vi"/>
			<Item Name="KepcoDCPwr Arbitrary Waveform.vi" Type="VI" URL="../KpDcpwr/KepcoDCPwr Arbitrary Waveform.vi"/>
			<Item Name="KepcoDCPwr Current List Example.vi" Type="VI" URL="../KpDcpwr/KepcoDCPwr Current List Example.vi"/>
			<Item Name="KepcoDCPwr Current Software Timed Ramp Example.vi" Type="VI" URL="../KpDcpwr/KepcoDCPwr Current Software Timed Ramp Example.vi"/>
			<Item Name="KepcoDCPwr Function Generator.vi" Type="VI" URL="../KpDcpwr/KepcoDCPwr Function Generator.vi"/>
			<Item Name="KepcoDCPwr Interactive Example.vi" Type="VI" URL="../KpDcpwr/KepcoDCPwr Interactive Example.vi"/>
			<Item Name="KepcoDCPwr Software Timed current Ramp.vi" Type="VI" URL="../KpDcpwr/KepcoDCPwr Software Timed current Ramp.vi"/>
			<Item Name="KepcoDCPwr Software Timed Ramp Example.vi" Type="VI" URL="../KpDcpwr/KepcoDCPwr Software Timed Ramp Example.vi"/>
			<Item Name="KepcoDCPwr Software Timed Ramp.vi" Type="VI" URL="../KpDcpwr/KepcoDCPwr Software Timed Ramp.vi"/>
			<Item Name="KepcoDCPwr Voltage List Example.vi" Type="VI" URL="../KpDcpwr/KepcoDCPwr Voltage List Example.vi"/>
		</Item>
		<Item Name="subVIs" Type="Folder">
			<Item Name="PrepInputFileForKepcoInput.vi" Type="VI" URL="../subVIs/PrepInputFileForKepcoInput.vi"/>
			<Item Name="ReadFileForCurrentList.vi" Type="VI" URL="../subVIs/ReadFileForCurrentList.vi"/>
		</Item>
		...
		<Item Name="KepcoBOP.lvclass" Type="LVClass" URL="../KepcoBOP.lvclass"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="KepcoBOP" Type="Source Distribution">
				<Property Name="Bld_buildCacheID" Type="Str">{26185D4D-024D-4149-836D-BB48862E2499}</Property>
				<Property Name="Bld_buildSpecDescription" Type="Str">Added the ability to load and then execute a current list</Property>
				<Property Name="Bld_buildSpecName" Type="Str">KepcoBOP</Property>
				...
				<Property Name="Source[0].itemID" Type="Str">{D4477BB6-06AE-4E79-8769-F936C20BE1B4}</Property>
				<Property Name="Source[0].type" Type="Str">Container</Property>
				<Property Name="Source[1].destinationIndex" Type="Int">0</Property>
				<Property Name="Source[1].itemID" Type="Ref">/My Computer/KepcoBOP.lvclass</Property>
