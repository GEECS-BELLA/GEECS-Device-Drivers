...
<Project Type="Project" LVVersion="20008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="SupportLibraries" Type="Folder">
			<Item Name="PicomotorController.lvclass" Type="LVClass" URL="../SupportLibs/PicomotorAxisClass/PicomotorController.lvclass"/>
		</Item>
		...
		<Item Name="Picomotor8752.lvclass" Type="LVClass" URL="../Picomotor8752.lvclass"/>
		<Item Name="Pico Init.vi" Type="VI" URL="../subvis/Example_LabVIEW 6.1_MCL Rev E.llb/Pico Init.vi"/>
		<Item Name="demonstrate cluster operations.vi" Type="VI" URL="../subvis/demonstrate cluster operations.vi"/>
		<Item Name="ChannelsCluster.ctl" Type="VI" URL="../TypeDefs/ChannelsCluster.ctl"/>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Error.ctl" Type="VI" URL="../subvis/Example_LabVIEW 6.1_MCL Rev E.llb/Error.ctl"/>
			<Item Name="Pico Parameters.ctl" Type="VI" URL="../subvis/Example_LabVIEW 6.1_MCL Rev E.llb/Pico Parameters.ctl"/>
			<Item Name="CLP Status Byte.ctl" Type="VI" URL="../subvis/Example_LabVIEW 6.1_MCL Rev E.llb/CLP Status Byte.ctl"/>
			<Item Name="Pico Ultra Status Byte.ctl" Type="VI" URL="../subvis/Example_LabVIEW 6.1_MCL Rev E.llb/Pico Ultra Status Byte.ctl"/>
			<Item Name="Pico Motor Status Byte.ctl" Type="VI" URL="../subvis/Example_LabVIEW 6.1_MCL Rev E.llb/Pico Motor Status Byte.ctl"/>
			<Item Name="Semaphore.ctl" Type="VI" URL="../subvis/Example_LabVIEW 6.1_MCL Rev E.llb/Semaphore.ctl"/>
			<Item Name="VISA &amp; TCPIP Control.ctl" Type="VI" URL="../subvis/Example_LabVIEW 6.1_MCL Rev E.llb/VISA &amp; TCPIP Control.ctl"/>
			<Item Name="MCL Cmd Cluster.ctl" Type="VI" URL="../subvis/Example_LabVIEW 6.1_MCL Rev E.llb/MCL Cmd Cluster.ctl"/>
			<Item Name="MCL Driver.vi" Type="VI" URL="../subvis/Example_LabVIEW 6.1_MCL Rev E.llb/MCL Driver.vi"/>
			<Item Name="MCL Response.ctl" Type="VI" URL="../subvis/Example_LabVIEW 6.1_MCL Rev E.llb/MCL Response.ctl"/>
			<Item Name="Driver Motor for Set cmd.vi" Type="VI" URL="../subvis/Example_LabVIEW 6.1_MCL Rev E.llb/Driver Motor for Set cmd.vi"/>
			<Item Name="MCL Response De-code.vi" Type="VI" URL="../subvis/Example_LabVIEW 6.1_MCL Rev E.llb/MCL Response De-code.vi"/>
			<Item Name="Communicator.vi" Type="VI" URL="../subvis/Example_LabVIEW 6.1_MCL Rev E.llb/Communicator.vi"/>
			<Item Name="Serial Communication.vi" Type="VI" URL="../subvis/Example_LabVIEW 6.1_MCL Rev E.llb/Serial Communication.vi"/>
			<Item Name="VISA Configure Serial Port.vi" Type="VI" URL="../subvis/Example_LabVIEW 6.1_MCL Rev E.llb/VISA Configure Serial Port.vi"/>
			<Item Name="Serial Read with Timeout.vi" Type="VI" URL="../subvis/Example_LabVIEW 6.1_MCL Rev E.llb/Serial Read with Timeout.vi"/>
			<Item Name="TCPIP Communicator.vi" Type="VI" URL="../subvis/Example_LabVIEW 6.1_MCL Rev E.llb/TCPIP Communicator.vi"/>
			<Item Name="TCP MCL Write &amp; Read.vi" Type="VI" URL="../subvis/Example_LabVIEW 6.1_MCL Rev E.llb/TCP MCL Write &amp; Read.vi"/>
			<Item Name="Error to Warning.vi" Type="VI" URL="../subvis/Example_LabVIEW 6.1_MCL Rev E.llb/Error to Warning.vi"/>
			<Item Name="Pico Status.vi" Type="VI" URL="../subvis/Example_LabVIEW 6.1_MCL Rev E.llb/Pico Status.vi"/>
			<Item Name="CLP Motor Status.vi" Type="VI" URL="../subvis/Example_LabVIEW 6.1_MCL Rev E.llb/CLP Motor Status.vi"/>
			<Item Name="CLP Status Byte.vi" Type="VI" URL="../subvis/Example_LabVIEW 6.1_MCL Rev E.llb/CLP Status Byte.vi"/>
			<Item Name="Pico Ultra Status.vi" Type="VI" URL="../subvis/Example_LabVIEW 6.1_MCL Rev E.llb/Pico Ultra Status.vi"/>
			<Item Name="Pico Ultra Status Byte.vi" Type="VI" URL="../subvis/Example_LabVIEW 6.1_MCL Rev E.llb/Pico Ultra Status Byte.vi"/>
			<Item Name="Pico Motor Status.vi" Type="VI" URL="../subvis/Example_LabVIEW 6.1_MCL Rev E.llb/Pico Motor Status.vi"/>
			<Item Name="activeflag.ctl" Type="VI" URL="../../ESP301/SubVis/activeflag.ctl"/>
			<Item Name="Hardware limit.ctl" Type="VI" URL="../../ESP301/SubVis/Hardware limit.ctl"/>
			<Item Name="status_TypDef.ctl" Type="VI" URL="../../ESP301/SubVis/status_TypDef.ctl"/>
			<Item Name="ESP301.lvclass" Type="LVClass" URL="../../ESP301/ESP301.lvclass"/>
			<Item Name="Close.vi" Type="VI" URL="../../ESP301/SubVis/Newport ESP301/Public/Close.vi"/>
			<Item Name="Write Command and Read.vi" Type="VI" URL="../../ESP301/SubVis/Newport ESP301/Private/Write Command and Read.vi"/>
			<Item Name="Define Home.vi" Type="VI" URL="../../ESP301/SubVis/Newport ESP301/Public/Motion And Position Control/Define Home.vi"/>
			<Item Name="clear warning error.vi" Type="VI" URL="../../shared/clear warning error.vi"/>
			<Item Name="Reset.vi" Type="VI" URL="../../ESP301/SubVis/Newport ESP301/Public/General Mode Selection/Reset.vi"/>
			<Item Name="Revision Query.vi" Type="VI" URL="../../ESP301/SubVis/Newport ESP301/Public/Status/Revision Query.vi"/>
			<Item Name="Error Query.vi" Type="VI" URL="../../ESP301/SubVis/Newport ESP301/Public/Status/Error Query.vi"/>
			<Item Name="Initialize.vi" Type="VI" URL="../../ESP301/SubVis/Newport ESP301/Public/Initialize.vi"/>
			<Item Name="Set Motor OFF.vi" Type="VI" URL="../../ESP301/Set Motor OFF.vi"/>
			<Item Name="Set Backlash Compensation.vi" Type="VI" URL="../../ESP301/SubVis/Newport ESP301/Public/Trajectory/Set Backlash Compensation.vi"/>
			<Item Name="Read Actual Position.vi" Type="VI" URL="../../ESP301/SubVis/Newport ESP301/Public/Status/Read Actual Position.vi"/>
			<Item Name="Get Motor Power Status_mod.vi" Type="VI" URL="../../ESP301/SubVis/Get Motor Power Status_mod.vi"/>
			<Item Name="Get Axis Motion Status_mod.vi" Type="VI" URL="../../ESP301/SubVis/Get Axis Motion Status_mod.vi"/>
			<Item Name="Move To Hardware Travel Limit.vi" Type="VI" URL="../../ESP301/SubVis/Newport ESP301/Public/Motion And Position Control/Move To Hardware Travel Limit.vi"/>
			<Item Name="Get Axis Motion Status.vi" Type="VI" URL="../../ESP301/SubVis/Newport ESP301/Public/Status/Get Axis Motion Status.vi"/>
			<Item Name="Move Absolute.vi" Type="VI" URL="../../ESP301/SubVis/Newport ESP301/Public/Motion And Position Control/Move Absolute.vi"/>
			<Item Name="Stop Motion.vi" Type="VI" URL="../../ESP301/SubVis/Newport ESP301/Public/Motion And Position Control/Stop Motion.vi"/>
			<Item Name="Set Motor ON.vi" Type="VI" URL="../../ESP301/Set Motor ON.vi"/>
			<Item Name="Get Velocity.vi" Type="VI" URL="../../ESP301/SubVis/Newport ESP301/Public/Trajectory/Get Velocity.vi"/>
			<Item Name="build load configuration commands.vi" Type="VI" URL="../../BaseDriver/build load configuration commands.vi"/>
			<Item Name="GetClusterElementByName.lvlib" Type="Library" URL="../../shared/UtilsLib/ClusterManipulation/GetClusterElementByName.lvlib"/>
			...
			<Item Name="DoNotSetChannelList.vi" Type="VI" URL="../subvis/DoNotSetChannelList.vi"/>
			<Item Name="RelativeMoveChannelsList.vi" Type="VI" URL="../subvis/RelativeMoveChannelsList.vi"/>
			<Item Name="Read Visa Smart.vi" Type="VI" URL="../Read Visa Smart.vi"/>
			<Item Name="GetDeviceName.vi" Type="VI" URL="../subvis/GetDeviceName.vi"/>
			<Item Name="UpdatePositionValue.vi" Type="VI" URL="../subvis/UpdatePositionValue.vi"/>
			...
			<Item Name="write command and read multiple.vi" Type="VI" URL="../../ESP301/SubVis/Newport ESP301/Private/write command and read multiple.vi"/>
			...
			<Item Name="Check If Valid response.vi" Type="VI" URL="../../ESP301/Check If Valid response.vi"/>
			...
			<Item Name="AcquireTypeDef.ctl" Type="VI" URL="../../ESP301/AcquireTypeDef.ctl"/>
			<Item Name="ESP acquire FGV.vi" Type="VI" URL="../../ESP301/ESP acquire FGV.vi"/>
			...
			<Item Name="ESP wait till acq stops.vi" Type="VI" URL="../../ESP301/ESP wait till acq stops.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build">
			<Item Name="Picomotor8752" Type="Source Distribution">
				<Property Name="Bld_buildCacheID" Type="Str">{89CE1179-CAC6-4B20-8A10-1E0F1F3B89DD}</Property>
				<Property Name="Bld_buildSpecName" Type="Str">Picomotor8752</Property>
				...
				<Property Name="Bld_previewCacheID" Type="Str">{17352C1F-35DA-4E46-BEC0-87948B1B4B2A}</Property>
				...
				<Property Name="Source[0].itemID" Type="Str">{AC19DCEE-891B-4B25-A321-D32D634406AC}</Property>
				<Property Name="Source[0].type" Type="Str">Container</Property>
				<Property Name="Source[1].destinationIndex" Type="Int">0</Property>
				<Property Name="Source[1].itemID" Type="Ref">/My Computer/Picomotor8752.lvclass</Property>
				...
				<Property Name="Source[4].itemID" Type="Ref">/My Computer/Get TDEnum from TD__ogtk.vi</Property>
