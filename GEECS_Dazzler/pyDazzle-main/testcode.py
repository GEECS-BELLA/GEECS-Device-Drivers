...
# ------------------------------------------------------------------
# Ensure the repository root (the folder that contains the directory
# "pydazzle") is on the Python import path.
# ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# Imports – they now use the package name.
# ------------------------------------------------------------------
from pydazzle import Dazzler                     # thanks to __init__.py
from pydazzle.utils import load_dazzler_file   # absolute import of helper

# The helper we wrote in the previous answer (keeps the core logic separate)
from dazzler_opt_delay_peak_power import evaluate   # <-- keep this file in the same folder
