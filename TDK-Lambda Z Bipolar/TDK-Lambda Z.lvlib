...
&lt;TDK-Lambda, Z+ Series, Programmable Power Supply&gt;.</Property>
	...
	<Item Name="Public" Type="Folder">
		...
		<Item Name="Action-Status" Type="Folder">
			...
			<Item Name="Transient Memory (Store).vi" Type="VI" URL="../Public/Action-Status/Transient Memory (Store).vi"/>
		</Item>
		<Item Name="Configure" Type="Folder">
			...
			<Item Name="Configure Under Voltage Type.vi" Type="VI" URL="../Public/Configure/Configure Under Voltage Type.vi"/>
		...
		<Item Name="Utility" Type="Folder">
			...
			<Item Name="Unit Address.vi" Type="VI" URL="../Public/Utility/Unit Address.vi"/>
			<Item Name="Wait.vi" Type="VI" URL="../Public/Utility/Wait.vi"/>
			<Item Name="Write Read Instrument.vi" Type="VI" URL="../Public/Utility/Write Read Instrument.vi"/>
		</Item>
		<Item Name="dir.mnu" Type="Document" URL="../Public/dir.mnu"/>
		<Item Name="CloseTDK.vi" Type="VI" URL="../Public/CloseTDK.vi"/>
		<Item Name="InitializeTDK.vi" Type="VI" URL="../Public/InitializeTDK.vi"/>
		<Item Name="VI Tree.vi" Type="VI" URL="../Public/VI Tree.vi"/>
	</Item>
	<Item Name="Private" Type="Folder">
		<Property Name="NI.LibItem.Scope" Type="Int">2</Property>
		<Item Name="CheckSum Append.vi" Type="VI" URL="../Private/CheckSum Append.vi"/>
